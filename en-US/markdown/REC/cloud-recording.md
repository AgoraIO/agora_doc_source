...
| backgroundColor | string | false | The background color of the video canvas. Fill in an RGB hex value starting with a "#". The default value is `"#000000"`, the black color. |
