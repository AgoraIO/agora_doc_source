...
| videoWidth | number | true | The video width (pixel). The product of `videoWidth` and `videoHeight` should be less than or equal to 1920 × 1080. For the recommended values, see [how to set the output video resolution of the ](page recording mobile web mode). |
| videoHeight | number | true | The height of the output video (pixel). The product of `videoWidth` and `videoHeight` should be less than or equal to 1920 × 1080. For the recommended values, see [how to set the output video resolution of the ](page recording mobile web mode). |
