...
| videoWidth | number | true | The video width (pixel). The product of `videoWidth` and `videoHeight` should be less than or equal to 1920 × 1080. For recommended values, see [How to Set Output Video Resolution for Web Page Recording in the Mobile Mode](https://doc.shengwang.cn/faq/integration-issues/mobile-video-profile). |
