...
| videoBitrate | number | false | The bitrate of the output video  (Kbps). For different output video resolutions, the default value of `videoBitrate` is different: <br>- Output video resolution greater than or equal to 1280 × 720: default value is 2000. <br>- Output video resolution is less than 1280 × 720: the default value is 1500. |
