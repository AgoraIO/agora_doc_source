...
Unlike muting a chat room member, this kind of mute does not expire automatically and you need to call the `unMuteAllChatRoomMembers` method to unmuting all members in the chat room.
