...
Unlike muting a chat room member, this kind of mute has no expiration period, you need to call the `unMuteAllChatRoomMembers` method to unmuting all members in the chat room.
