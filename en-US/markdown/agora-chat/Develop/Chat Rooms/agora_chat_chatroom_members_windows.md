...
Unlike muting a chat room member, this kind of mute does not expire automatically after a period and you need to call the `UnMuteAllRoomMembers` method to unmute all members in the chat room.
