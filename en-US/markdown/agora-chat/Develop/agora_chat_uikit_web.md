...
This section introduces how to create an app and add the Chat UIKit to the project.
...
- `EaseApp`, which contains a conversation list and applies to use cases where you want to quickly launch a real-time chat app.
