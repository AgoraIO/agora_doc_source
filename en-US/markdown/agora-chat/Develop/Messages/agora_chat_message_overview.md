...
<div class="alert info">Attachments like images, voices, videos, and other files can be stored on the server for seven days by default. To raise the limit, you can contact <a href="mailto:support@agora.io">support@agora.io</a >.</div>