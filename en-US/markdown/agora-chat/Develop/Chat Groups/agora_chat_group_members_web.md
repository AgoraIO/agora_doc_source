...
Unlike muting a chat group member, this kind of mute has no expiration period, you need to call the `enableSendGroupMsg` method to unmute all members in the chat group.
