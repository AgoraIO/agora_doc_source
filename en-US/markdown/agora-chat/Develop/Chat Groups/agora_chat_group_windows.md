...
- You have initialized the Agora Chat SDK. For details, see [Get Started with Windows](https://docs-preprod.agora.io/en/agora-chat/agora_chat_get_started_windows).
...
The logic of joining a chat group varies according to the `GroupStyle` setting you choose when [creating the chat group](./agora_chat_group_windowsy#create-a-chat-group):
