...
Adds a chat group member to the group mute list. Once muted, members cannot send messages in the group.
...
Removes the specified user from the chat group mute list. Once removed from the mute list, users, can send messages in the chat group.
