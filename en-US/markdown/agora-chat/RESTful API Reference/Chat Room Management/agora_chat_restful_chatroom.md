...
| `maxusers` | Int | The maximum number of members (including the chat room owner) that can join a chat room. The value range is [1,10,000], with `1000` as the default.   | No |
