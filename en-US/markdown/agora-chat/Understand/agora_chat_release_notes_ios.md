...
3. Adds the pagination parameters `pageNum` and `pageSize` in the `getConversationsFromServer` method to allow users to get the conversation list from the server with pagination.
