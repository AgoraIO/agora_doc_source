...
| `user` | String | The ID of the login user, in the format of `{app key_username@easemob.com/device operating system_device ID}`, where the device ID is randomly generated by the SDK. |
