...
| `customEvent`| String | The type of the custom event. The type can be 1 to 32 character and must meet the following regular expression condition: [a-zA-Z0-9-_/.]{1,32}.|
