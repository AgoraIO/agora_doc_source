...
| `400`              |         N/A                            | "too many get presences"                                     | The error message returned because the number of users whose presence statuses you attempt to retrieve exceeds the limit.                            |
| `400`              |           N/A                          | "too many unsub presences"                                   | The error message returned because the number of users from whom you attempt to unsubscribe exceeds the limit.                                 |
