...
### `408` Request Timeout
The `408` status code indicates that the server does not receive the API request within the alloted time period.

### `413` Payload Too Large
The `413` status code indicates that the API request is larger than the server can process.
| Status code | Error code  | Error message | Description   |
| :-----  | :------------ | :----------------------------------------------------------- | :------------------------------------------------|
...
The `415` status code indicates that the format of the API request is not supported by the server.
| Status code | Error code  | Error message | Description   |
| :-----  | :------------ | :----------------------------------------------------------- | :------------------------------------------------|
