...
| 214    | USER_LOGIN_TOO_MANY_DEVICES     | The number of devices on which a user ID logs in exceeds the upper limit.               |
...
| 220    | USER_DEVICE_CHANGED             |  If you set that the login device takes precedence, a login attempt on another device triggers this error to notify that the login device is detected irregular.|
...
| 401    | FILE_INVALID                    | The request to upload a group shared file or a message attachment fails.          |
...
| 502    | MESSAGE_SEND_TRAFFIC_LIMIT      | Request too often. Agora recommends that you reduce the call frequency or the message size.  |
| 504    | MESSAGE_RECALL_TIME_LIMIT       |  A message cannot be recalled because the message exceeds the recall period.          |
| 505    | SERVICE_NOT_ENABLED             | The feature that you attempt to use is not activated. Contact support@agora.io to activate this feature for your user account.                      |
...
| 508    | MESSAGE_EXTERNAL_LOGIC_BLOCKED  | The message that you send is blocked by the logic defined in your own server.  |
...
| 601    | GROUP_ALREADY_JOINED            | The request to join a chat group fails because you have already in the chat group.       |
...
| 603    | GROUP_PERMISSION_DENIED         |  You do not have the privilege to perform the operation to a chat group. For example, a chat group member does not have the permission to add or remove a chat group admin.      |
| 604    | GROUP_MEMBERS_FULL              |  The number of chat group members exceeds the upper limit.                                     |
| 605    | GROUP_NOT_EXIST                 |  The chat group to which you request to perform operations does not exist.                    |
...
| 701    | CHATROOM_ALREADY_JOINED         |  The request to join a chat room fails because you have already in the chat room.  |
...
| 703    | CHATROOM_PERMISSION_DENIED      | You do not have the privilege to perform the operation to a chat room. For example, a chat room member does not have the permission to add or remove a chat room admin.   |
| 704    | CHATROOM_MEMBERS_FULL           |   The number of chat room members exceeds the upper limit.                              |
| 705    | CHATROOM_NOT_EXIST              | The chat room to which you request to perform operations does not exist.                 |
