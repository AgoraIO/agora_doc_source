...
This page shows the minimum code you need to integrate high-quality, low-latency live streaming experiences into your app using the Interactive Live Streaming SDK for Android.
...
Follow the steps to create the environment necessary to integrate live streaming into your app.
...
3. Initialize the app and join the channel.
   ...
   Call the core methods for joining a channel to the `MainActivity` class. In the following sample code, `initializeAndJoinChannel` function is used to encapsulate these core methods.
