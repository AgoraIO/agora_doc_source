...
- Updated `@Netless/white-audio-plugin` to 1.2.23 to fix the display of audio files in whiteboard playback.
- The asynchronous `getRoomState` method had no callbacks.
