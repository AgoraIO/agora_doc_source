...
- `dimensions`：视频编码的分辨率（px）。 默认值为 640 × 360。 通常情况下，分辨率越高，视频的清晰度会越好。 该参数的值不代表最终视频输出的方向。 点击[旋转方向模式](#orientationmode)了解如何设置视频输出的方向模式。
...
| 960 × 720         | 15          | 1820            |
| 960 × 720         | 30          | 2760            |
| 1920 × 1080 （仅 macOS 平台） | 15   | 4160 |
| 1920 × 1080（仅 macOS 平台）  | 30   | 6300 |
| 1920 × 1080（仅 macOS 平台）  | 60   | 6500 |

视频是否能达到 960 × 720 或者更高的分辨率取决于终端设备的性能。