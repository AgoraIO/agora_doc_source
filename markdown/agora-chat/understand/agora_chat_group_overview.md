...
| 创建方式 | 所有 app 用户都可以创建群组。   | 仅 [超级管理员](https://docs.agora.io/cn/agora-chat/agora_chat_restful_chatroom_superadmin?platform=RESTful) 有权限创建聊天室。  |
...
任何聊天用户都可以创建群组。创建群组的用户成为其所有者。支持的群组数量和群组成员的最大数量因选择的版本而异。有关详细信息，请参阅 [群组成员总数限制](https://docs.agora.io/cn/agora-chat/limitations)。
