...
- 完成即时通讯 IM SDK 初始化，详见[Web 入门](https://docs.agora.io/cn/agora-chat/agora_chat_get_started_web?platform=Web)。
- 了解即时通讯 IM API 的[使用限制](https://docs.agora.io/cn/agora-chat/agora_chat_limitation?platform=Web)中所述。

所有类型的 [定价计划](https://docs.agora.io/cn/agora-chat/agora_chat_plan) 都支持该功能，并且在 [Agora 控制台](https://console.agora.io/) 中启用聊天后默认启用。
...
有关发送消息的更多信息，请参阅 [发送消息](https://docs.agora.io/cn/agora-chat/agora_chat_send_receive_message_web?platform=Web#send-a-text-message)。
...
有关接收消息的更多信息，请参阅 [接收消息](https://docs.agora.io/cn/agora-chat/agora_chat_send_receive_message_web?platform=Web#receive-a-message)。
...
有关撤回消息的更多信息，请参阅撤回 [消息](https://docs.agora.io/cn/agora-chat/agora_chat_send_receive_message_web?platform=Web#recall-a-message)。

### 从服务器获取子区消息

关于如何从服务器获取子区消息的详细信息，请参见从服务器获取 [历史消息](https://docs.agora.io/cn/agora-chat/agora_chat_retrieve_message_web?platform=Web#retrieve-historical-messages-of-the-specified-conversation)。