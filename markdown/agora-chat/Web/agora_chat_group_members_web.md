...
邀请用户入群，详见 [创建群组](https://docs.agora.io/cn/agora-chat/agora_chat_group_web?platform=Web#创建群组)。
...
1. 用户可获取 [获取群组列表](https://docs.agora.io/cn/agora-chat/agora_chat_group_web?platform=Web#获取群组列表)。
...
也可以通过 [获取群组详情信息](https://docs.agora.io/cn/agora-chat/agora_chat_group_web?platform=Web#获取群组详情信息) 获取管理员列表。
...
有关详细信息，请参阅 [监听事件](https://docs.agora.io/cn/agora-chat/agora_chat_group_web?platform=Web#listen-for-chat-group-events)。