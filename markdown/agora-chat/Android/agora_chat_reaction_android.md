...
- 集成 v1.0.3 及以上即时通讯 IM SDK 版本，并实现了 [基本的实时聊天功能](https://docs.agora.io/cn/agora-chat/agora_chat_get_started_android?platform=Android)。
...
[Chat UIKit](https://docs.agora.io/cn/agora-chat/agora_chat_uikit_android?platform=Android) 也支持 Reaction 功能，其中包含更丰富的表情符号。你可以使用 UIKit 在项目中实现 Reaction 功能。