...
- 完成 SDK 初始化，并连接到服务器，详见 [即时通讯 IM 入门](https://docs.agora.io/cn/agora-chat/agora_chat_get_started_ios?platform=iOS)。
- 了解即时通讯 IM [使用限制](https://docs.agora.io/cn/agora-chat/agora_chat_limitation?platform=iOS)。
...
- [消息回执](https://docs.agora.io/cn/agora-chat/agora_chat_message_receipt_ios?platform=iOS)