...
title: Record a Call
platform: Java
updatedAt: 2020-04-29 16:45:47
---
This page demonstrates how to record a call by using the command line. You can also record calls by calling the API methods. For the detailed API reference, see [Recording API](./API%20Reference/recording_java/index.html). The command line and API methods implement the same functions. 

Ensure you integrate the recording SDK before proceeding, see [Integrate the SDK](/en/Recording/recording_integrate_java).
...
- `layoutMode`：Sets the video mixing layout. See [Set Video Layout](/en/Recording/recording_layout) for details.
...
After the recording is complete, use the transcoding script to merge the recorded files. See [Using the Transcoding Script](/en/Recording/recording_merge_files).

If any error or warning occurs during the recording, see [Error codes](./API%20Reference/recording_java/enumio_1_1agora_1_1recording_1_1common_1_1_common_1_1_e_r_r_o_r___c_o_d_e___t_y_p_e.html) and [Warning codes](./API%20Reference/recording_java/enumio_1_1agora_1_1recording_1_1common_1_1_common_1_1_w_a_r_n___c_o_d_e___t_y_p_e.html).
