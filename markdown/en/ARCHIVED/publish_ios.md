...
---
Before publishing or subscribing to any streams, ensure that you prepared the development environment and joined the channel. See [Integrate the SDK](/en/Video/ios_video).
...
- [Leave the Channel](/en/Video/leave_ios)
...
- [Play the Audio Effects/Audio Mixing](/en/Video/effect_mixing_ios)
...
- [Customize the Video/Audio Source and Renderer](/en/Video/custom_video_ios)
- [Share the Screen](/en/Video/screensharing_ios)
