...
- To inject an online media stream:
	...
	You can modify the parameter values of `config` to set audio sampling rate, audio bitrate and audio channel numbers of the injected stream. For more information, see [Agora Live Inject Stream Config](./API%20Reference/cpp/structagora_1_1rtc_1_1_inject_stream_config.html).
