...
| `1512`     | The camera is already in use.<div class="alert note">**Note:** This method is **deprecated** as of v2.4.1. Please use `LOCAL_VIDEO_STREAM_ERROR_DEVICE_BUSY(3)` in the `onLocalVideoStateChanged` callback instead.</div> |
...
For details about the error and warning codes that may occur when you use the Agora RTC Web SDK, see [Error codes](./API%20Reference/web/index.html#error-codes) and [Warning codes](./API%20Reference/web/index.html#warning-codes).
