...
Before setting the audio profile, ensure that you have implemented the basic real-time communication functions in your project. For details, see [Start a Call](start_call_windows) or [Start Live Interactive Streaming](start_live_windows).
...
<td>Sets the audio scenario. For example, entertainment, education, or live gaming. The Agora SDK optimizes the noise control and audio quality based on the scenarios.
 ...
 <li>AUDIO_SCENARIO_GAME_STREAMING(3): The live gaming scenario, enabling the gaming audio effects in the speaker mode in a interactive live streaming scenario. Choose this scenario for high-fidelity music playback.</li>
...
Call this method before calling the [`joinChannel`](./API%20Reference/cpp/classagora_1_1rtc_1_1_i_rtc_engine.html#adc937172e59bd2695ea171553a88188c) method.
