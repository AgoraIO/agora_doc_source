...
Before proceeding, ensure that you implement the basic interactive live streaming in your project. See [Start Live Interactive Streaming](start_live_ios) for details.
