agora_rtc_engine: ^6.0.0 是基于声网 SDK v4.0.0 是一个新的 SDK 版本，可帮助用户将实时音视频功能集成到 app 中。在大规模的实时互动场景下，你可以用它实现更好的实时互动效果，详见[产品概述](./product_live_ng#benefits)。
...
agora_rtc_engine: ^6.0.0 SDK 对部分功能的实现方式进行了优化或修改，从而导致与 agora_rtc_engine: ^5.x 不兼容。为了继续使用 app 中已有的声网功能，请根据[变更介绍](#changes)更新 app 中的代码。
