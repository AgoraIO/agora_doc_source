...
## v6.6.2 (corresponds to Native SDK v4.6.2)

This version was released on February x, 2026.
...
11. **Advanced Beauty (Beta)**
   ...
   - **Unified and Simple API**: Manage all beauty, makeup, and filter functions through three core nodes – `BEAUTY`, `STYLE_MAKEUP`, and `FILTER` – using `VideoEffectObject` for unified parameter setup and lifecycle control.
...
3. **Window exclusion support for second screen**
...
4. **Optimization of onVideoDeviceStateChanged callback timing**
...
5. **Improved accuracy of onNetworkQuality**
...
6. **Support for 24k sample rate audio frames in onPlaybackAudioFrame**
...
7. **Support for obtaining channel ID in onEncodedVideoFrameReceived callback**
