...
| `stopPrimaryCameraCapture``stopSecondaryCameraCapture`       | `stopCameraCapture`       |
| `startPrimaryScreenCapture``startSecondaryScreenCapture`     | `startScreenCapture`[2/2] |
| `stopPrimaryScreenCapture``stopSecondaryScreenCapture`       | `stopScreenCapture`[2/2]  |
