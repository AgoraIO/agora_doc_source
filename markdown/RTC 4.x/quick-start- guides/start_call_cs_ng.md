...
请参考[快速入门：在 Visual Studio 中安装和使用包](https://learn.microsoft.com/zh-cn/nuget/quickstart/install-and-use-a-package-in-visual-studio)，将视频 SDK 集成到项目中。你可以在 [nuget](https://www.nuget.org/packages/agora_rtc_sdk/#versions-body-tab) 中获取 agora_rtc_sdk 的版本信息。
