本文展示声网云端录制产品（除页面录制）的计费方式。页面录制计费详见[页面录制计费说明](/cn/cloud-recording/billing_cloud_recording_web?platform=RESTful)。
...
$$ 5514ade0-a6ed-11ea-aa07-c5bcc14a9a95
{
  "product": "云端录制"
}
$$
...
~9b95ffe0-a6e2-11ea-aa07-c5bcc14a9a95~

### 时长用量

针对录制服务，声网从开始录制计算时长用量，到结束录制停止计量。**时长用量的精度为秒**。
...
~bb904590-508c-11eb-a503-83389f959a94~
...
假设你的声网开发者账号下有一个启用的项目，项目名为 Test，该项目使用声网云端录制实现了录制功能。
...
<div class="alert note"><ul><li>声网会将每月的总费用四舍五入，并保留两位小数点。</li><li>声网给予每个声网开发者账号每个月一万分钟的免费时长。上述示例中的时长用量如果是该声网开发者账号下所有项目的总时长用量，实际的费用为 0 元。</li></ul></div>
...
$$ 023bb230-1ade-11ea-a462-d5a168bac73c
{
  "product": "云端录制"
}
$$
...
$$ eec98eb0-1ade-11ea-a462-d5a168bac73c
{
  "product": "云端录制"
}
$$
...
## 相关文档
~5d9e03a0-a6f0-11ea-aa07-c5bcc14a9a95~