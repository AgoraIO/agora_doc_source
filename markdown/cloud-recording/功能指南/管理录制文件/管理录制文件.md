...
如需将原 M3U8 文件与启用高可用机制后生成的新 M3U8 文件合并为一个 MP4 文件，你可以按照如下步骤使用 [Transcoder](https://download.agora.io/ardsdk/release/rtsc-ha_transcoder.v1.1.9-202204180321-release-prod.tar.gz) 脚本进行文件合并（仅适用于合流录制文件）：
1. 环境准备。
