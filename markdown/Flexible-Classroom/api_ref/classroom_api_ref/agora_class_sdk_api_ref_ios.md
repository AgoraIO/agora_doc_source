...
| `userUuid`       | 用户 ID，String 型。这是用户的全局唯一标识，需要与你生成 Token 时使用的 UID 一致。长度在 64 字节以内。以下为支持的字符集范围（共 89 个字符）: <li>26 个小写英文字母 a-z<li>26 个大写英文字母 A-Z<li>10 个数字 <li>0-9<li>空格<li>"!", "#", "$", "%", "&", "(", ")", "+", "-", ":", ";", "<", "=", ".", ">", "?", "@", "[", "]", "^", "\_", " {", "}", "\|", "~", "," |
...
| `token`          | 用于鉴权的 Token，String 型，详见[使用 Token 鉴权](generate-token)。                                                                                                                                                                                                                                                                                                                                            |
