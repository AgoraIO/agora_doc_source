...
![](https://web-cdn.agora.io/docs-files/1670229252571)

## 通过 CocoaPods 集成灵动课堂教育场景

如果你使用灵动课堂教育场景的默认 UI，无需修改灵动课堂教育场景的代码，则可参考以下步骤通过 CocoaPods 添加远程依赖集成完整的灵动课堂教育场景：
...
## 通过 CocoaPods 集成灵动课堂监考场景

如果你使用灵动课堂监考场景的默认 UI，无需修改灵动课堂监考场景的代码，则可参考以下步骤通过 CocoaPods 添加远程依赖集成完整的灵动课堂监考场景：
