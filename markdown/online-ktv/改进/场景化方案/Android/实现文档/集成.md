...
<div class="alert note">开始前请确保你已参考<a href="https://docs.agora.io/cn/online-ktv/chorus_client_android?platform=Android#项目配置">项目配置</a>集成所需 SDK。</div>
...
![](https://web-cdn.agora.io/docs-files/1678788560007)
