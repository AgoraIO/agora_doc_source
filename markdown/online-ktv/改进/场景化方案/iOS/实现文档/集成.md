...
| 音乐播放器核心 API                   | 实现功能                                       |
| :----------------------------------- | :--------------------------------------------- |
| `sharedContentCenterWithConfig`      | 初始化 `AgoraMusicContentCenter` 。            |
| `createMusicPlayerWithDelegate`      | 创建音乐播放器。                               |
| `registerEventDelegate`              | 注册音乐内容中心回调事件。                     |
| `getMusicCharts`                     | 获取全部的音乐榜单。                           |
| `getMusicCollectionWithMusicChartId` | 通过音乐榜单的 ID 获取指定榜单的音乐资源列表。 |
| `searchMusicWithKeyWord`             | 搜索音乐资源。                                 |
| `preloadWithSongCode`                | 预加载音乐资源。                               |
| `isPreloadedWithSongCode`            | 检测音乐资源是否已被预加载。                   |
| `getLyricWithSongCode`               | 获取音乐资源的歌词下载地址。                   |
| `openMediaWithSongCode`              | 打开音乐资源。                                 |
