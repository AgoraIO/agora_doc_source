...
![](https://web-cdn.agora.io/docs-files/1602217869726)

- 管理商品列表

<div class="alert note">下图仅供参考。如果你需要使用商品列表功能，需要自行设计并部署。</div>

![](https://web-cdn.agora.io/docs-files/1602218173155)
...
- 房主加入直播间并开始直播
 ![](https://web-cdn.agora.io/docs-files/1602215682095)

- 房主与观众连麦互动
 ![](https://web-cdn.agora.io/docs-files/1602215714028)

- 房主发起 PK 连麦邀请
 ![](https://web-cdn.agora.io/docs-files/1602215737397)
...
| [sendMessageToPeer](https://docs.agora.io/cn/Real-time-Messaging/API%20Reference/RTM_java/classio_1_1agora_1_1rtm_1_1_rtm_client.html#a729079805644b3307297fb2e902ab4c9) | 发送点对点消息，可用于主播向观众或另一个房间的主播发送连麦邀请；也可用于观众向主播发送上麦申请。|
...
| [setupLocalVideo](https://docs.agora.io/cn/Interactive%20Broadcast/API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#a1fa43a5ce24196e840bcb1062cadbf23) | 设置本地视图。主播或连麦主播需要调用该方法，才能在本地看到自己的画面。 |
...
| [setupRemoteVideo](https://docs.agora.io/cn/Interactive%20Broadcast/API%20Reference/java/classio_1_1agora_1_1rtc_1_1_rtc_engine.html#a0e9f693c9bc2ccb91554c2c7dc6b7140) | 设置远端视图。观众或目标频道主播同意连麦后，源频道主播需要调用该方法，才能看到连麦主播的视频画面。|
