...
updatedAt: 2020-11-11 11:47:23
---
## 场景描述

1 位老师对 1 位学生进行专属线上辅导教学，老师和学生能实时音视频互动，这就是典型的 1 对 1 互动教学场景。常见的 1 对 1 互动教学有 1 对 1 在线课外辅导、1 对 1 在线语言教学和 1 对 1 在线音乐陪练等。

![](https://web-cdn.agora.io/docs-files/1579587590848)

## <a name="demo"></a>App 体验

Agora 为 1 对 1 互动教学提供如下示例 app，点击链接进入应用。
...
打开应用后，按屏幕提示依次填入房间号、用户名，并选择**一对一**教室。根据你的平台选择老师或学生，点击**加入房间**即可体验。
