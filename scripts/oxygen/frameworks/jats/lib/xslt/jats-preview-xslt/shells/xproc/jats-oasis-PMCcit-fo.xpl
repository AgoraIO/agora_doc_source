...
<p:declare-step xmlns:p="http://www.w3.org/ns/xproc"
   ...
   <p:xslt name="exclude-web-only" version="2.0">
      <!-- exclude elements with @specific-use='web-only' -->
      <p:input port="stylesheet">
         <p:document href="../../xslt/prep/jats-printfilter.xsl"/>
      </p:input>
   </p:xslt>

   <p:xslt name="oasis-tables-to-html" version="2.0">
      <!-- convert OASIS tables to HTML -->
      <p:input port="stylesheet">
         <p:document href="../../xslt/oasis-tables/oasis-table-html.xsl"/>
      </p:input>
   </p:xslt>

   <p:xslt name="convert-xslfo" version="2.0">
      <!-- run FO conversion -->
      <p:input port="stylesheet">
         <p:document href="../../xslt/main/jats-xslfo.xsl"/>
      </p:input>
   </p:xslt>
