...
<xsl:stylesheet xmlns:dcr="http://www.isocat.org/ns/dcr"
   ...
   <!--PATTERN schematron-constraint-tei_speech-att.spanning-spanTo-spanTo-2-8-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_speech-p-abstractModel-structure-p-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-p-abstractModel-structure-l-11-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-desc-deprecationInfo-only-in-deprecated-12-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-rt-target-rt-target-not-span-13-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-rt-from-rt-from-14-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-rt-to-rt-to-15-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-ptr-ptrAtts-16-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_speech-ref-refAtts-17-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-list-gloss-list-must-have-labels-18-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-relatedItem-targetorcontent1-19-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_speech-l-abstractModel-structure-l-20-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-lg-atleast1oflggapl-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-lg-abstractModel-structure-l-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-quotation-quotationContents-23-->
   <!--RULE -->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_speech-citeStructure-delim-citestructure-inner-delim-24-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-citeStructure-match-citestructure-outer-match-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-citeStructure-match-citestructure-inner-match-26-->
   <!--RULE -->
   <xsl:template match="tei:citeStructure[parent::tei:citeStructure]"
                 priority="1000"
                 mode="M30">
   ...
   <!--PATTERN schematron-constraint-tei_speech-div-abstractModel-structure-l-29-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-div-abstractModel-structure-p-30-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-shift-shiftNew-31-->
   <!--RULE -->
...
remarkable at this point. (@new / warning)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_speech-relation-reforkeyorname-32-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-relation-activemutual-33-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-relation-activepassive-34-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-objectIdentifier-objectIdentifier_minimal-35-->
   <!--RULE -->
   <xsl:template match="tei:objectIdentifier" priority="1000" mode="M37">
   ...
   <!--PATTERN schematron-constraint-tei_speech-link-linkTargets3-36-->
   <!--RULE -->
   <xsl:template match="tei:link" priority="1000" mode="M38">
   ...
   <!--PATTERN schematron-constraint-tei_speech-ab-abstractModel-structure-ab-37-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-ab-abstractModel-structure-l-38-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_speech-join-joinTargets3-39-->
   <!--RULE -->
   <xsl:template match="tei:join" priority="1000" mode="M41">
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_speech-standOff-nested_standOff_should_be_typed-40-->
   <!--RULE -->
   <xsl:template match="tei:standOff" priority="1000" mode="M42">
