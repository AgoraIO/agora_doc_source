...
<xsl:stylesheet xmlns:dcr="http://www.isocat.org/ns/dcr"
   ...
   <!--PATTERN schematron-constraint-tei_all-att.spanning-spanTo-spanTo-2-8-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-p-abstractModel-structure-p-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-p-abstractModel-structure-l-11-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-desc-deprecationInfo-only-in-deprecated-12-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-rt-target-rt-target-not-span-13-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-rt-from-rt-from-14-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-rt-to-rt-to-15-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-ptr-ptrAtts-16-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-ref-refAtts-17-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-list-gloss-list-must-have-labels-18-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-relatedItem-targetorcontent1-19-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_all-l-abstractModel-structure-l-20-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-lg-atleast1oflggapl-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-lg-abstractModel-structure-l-22-->
   <!--RULE -->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-citeStructure-delim-citestructure-inner-delim-24-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-citeStructure-match-citestructure-outer-match-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-citeStructure-match-citestructure-inner-match-26-->
   <!--RULE -->
   <xsl:template match="tei:citeStructure[parent::tei:citeStructure]"
                 priority="1000"
                 mode="M34">
   ...
   <!--PATTERN schematron-constraint-tei_all-div-abstractModel-structure-l-29-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-div-abstractModel-structure-p-30-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-shift-shiftNew-31-->
   <!--RULE -->
...
remarkable at this point. (@new / warning)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_all-s-noNestedS-32-->
   <!--RULE -->
   <xsl:template match="tei:s" priority="1000" mode="M38">
   ...
   <!--PATTERN schematron-constraint-tei_all-span-targetfrom-33-->
   <!--RULE -->
   <xsl:template match="tei:span" priority="1000" mode="M39">
...
Only one of the attributes @target and @from may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-span-targetto-34-->
   <!--RULE -->
   <xsl:template match="tei:span" priority="1000" mode="M40">
...
Only one of the attributes @target and @to may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-span-tonotfrom-35-->
   <!--RULE -->
   <xsl:template match="tei:span" priority="1000" mode="M41">
...
If @to is supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-span-tofrom-36-->
   <!--RULE -->
   <xsl:template match="tei:span" priority="1000" mode="M42">
...
The attributes @to and @from on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-catchwords-catchword_in_msDesc-37-->
   <!--RULE -->
   <xsl:template match="tei:catchwords" priority="1000" mode="M43">
   ...
   <!--PATTERN schematron-constraint-tei_all-dimensions-duplicateDim-38-->
   <!--RULE -->
   <xsl:template match="tei:dimensions" priority="1000" mode="M44">
...
The element <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-secFol-secFol_in_msDesc-39-->
   <!--RULE -->
   <xsl:template match="tei:secFol" priority="1000" mode="M45">
   ...
   <!--PATTERN schematron-constraint-tei_all-signatures-signatures_in_msDesc-40-->
   <!--RULE -->
   <xsl:template match="tei:signatures" priority="1000" mode="M46">
   ...
   <!--PATTERN schematron-constraint-tei_all-msIdentifier-msId_minimal-41-->
   <!--RULE -->
   <xsl:template match="tei:msIdentifier" priority="1000" mode="M47">
   ...
   <!--PATTERN schematron-constraint-tei_all-path-pathmustnotbeclosed-42-->
   <!--RULE -->
   <xsl:template match="tei:path[@points]" priority="1000" mode="M48">
   ...
   <!--RULE -->
   <xsl:template match="tei:addSpan" priority="1000" mode="M49">
   ...
   <!--RULE -->
   <xsl:template match="tei:damageSpan" priority="1000" mode="M50">
...
The @spanTo attribute of <xsl:text/>
   ...
   <!--RULE -->
   <xsl:template match="tei:delSpan" priority="1000" mode="M51">
   ...
   <!--RULE -->
   <xsl:template match="tei:subst" priority="1000" mode="M52">
   ...
   <!--PATTERN schematron-constraint-tei_all-rdgGrp-only1lem-50-->
   <!--RULE -->
   <xsl:template match="tei:rdgGrp" priority="1000" mode="M53">
   ...
   <!--PATTERN schematron-constraint-tei_all-variantEncoding-location-variantEncodingLocation-51-->
   <!--RULE -->
   <xsl:template match="tei:variantEncoding" priority="1000" mode="M54">
   ...
   <!--PATTERN schematron-constraint-tei_all-relation-reforkeyorname-52-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-relation-activemutual-53-->
   <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M56">
   ...
   <!--PATTERN schematron-constraint-tei_all-relation-activepassive-54-->
   <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M57">
   ...
   <!--PATTERN schematron-constraint-tei_all-objectIdentifier-objectIdentifier_minimal-55-->
   <!--RULE -->
   <xsl:template match="tei:objectIdentifier" priority="1000" mode="M58">
   ...
   <!--PATTERN schematron-constraint-tei_all-link-linkTargets3-56-->
   <!--RULE -->
   <xsl:template match="tei:link" priority="1000" mode="M59">
   ...
   <!--PATTERN schematron-constraint-tei_all-ab-abstractModel-structure-ab-57-->
   <!--RULE -->
   <xsl:template match="tei:ab" priority="1000" mode="M60">
   ...
   <!--PATTERN schematron-constraint-tei_all-ab-abstractModel-structure-l-58-->
   <!--RULE -->
   <xsl:template match="tei:ab" priority="1000" mode="M61">
   ...
   <!--PATTERN schematron-constraint-tei_all-join-joinTargets3-59-->
   <!--RULE -->
   <xsl:template match="tei:join" priority="1000" mode="M62">
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-standOff-nested_standOff_should_be_typed-60-->
   <!--RULE -->
   <xsl:template match="tei:standOff" priority="1000" mode="M63">
   ...
   <!--PATTERN schematron-constraint-tei_all-att.repeatable-MINandMAXoccurs-61-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-att.identified-spec-in-module-62-->
   <!--RULE -->
...
should correspond to an existing module, via a moduleSpec or
   ...
   <!--PATTERN schematron-constraint-tei_all-att.deprecated-validUntil-deprecation-two-month-warning-63-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-att.deprecated-validUntil-deprecation-should-be-explained-64-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-moduleRef-modref-65-->
   <!--RULE -->
...
Child elements of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_all-moduleRef-prefix-not-same-prefix-66-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-schemaSpec-deprecate_schemaSpec_in_bizarre_places-67-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-elementSpec-child-constraint-based-on-mode-68-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-model-no_dup_default_models-69-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-model-no_dup_models-70-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-modelSequence-no_outputs_nor_predicates_4_my_kids-71-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-sequence-sequencechilden-72-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-alternate-alternatechilden-73-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-constraintSpec-sch_no_more-74-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-constraintSpec-isosch-75-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-constraintSpec-needrules-76-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-attDef-attDefContents-77-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-attDef-noDefault4Required-78-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-attDef-defaultIsInClosedList-twoOrMore-79-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-attDef-defaultIsInClosedList-one-80-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-dataRef-restrictDataFacet-81-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-dataRef-restrictAttRestriction-82-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_all-dataRef-restrictAttResctrictionName-83-->
   <!--RULE -->
