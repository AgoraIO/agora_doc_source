...
<xsl:stylesheet xmlns:dcr="http://www.isocat.org/ns/dcr"
   ...
   <!--SCHEMATRON PATTERNS-->
   <!--PATTERN schematron-constraint-tei_ms-att.datable.w3c-att-datable-w3c-when-1-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-att.datable.w3c-att-datable-w3c-from-2-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-att.datable.w3c-att-datable-w3c-to-3-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-att.datable-calendar-calendar-4-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-att.measurement-att-measurement-unitRef-5-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-att.typed-subtypeTyped-6-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-att.pointing-targetLang-targetLang-7-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-att.spanning-spanTo-spanTo-2-8-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-att.styleDef-schemeVersion-schemeVersionRequiresScheme-9-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-p-abstractModel-structure-p-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-p-abstractModel-structure-l-11-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-desc-deprecationInfo-only-in-deprecated-12-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-rt-target-rt-target-not-span-13-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-rt-from-rt-from-14-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-rt-to-rt-to-15-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-ptr-ptrAtts-16-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-ref-refAtts-17-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-list-gloss-list-must-have-labels-18-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-relatedItem-targetorcontent1-19-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_ms-l-abstractModel-structure-l-20-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-lg-atleast1oflggapl-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-lg-abstractModel-structure-l-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-quotation-quotationContents-23-->
   <!--RULE -->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-citeStructure-delim-citestructure-inner-delim-24-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-citeStructure-match-citestructure-outer-match-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-citeStructure-match-citestructure-inner-match-26-->
   <!--RULE -->
   <xsl:template match="tei:citeStructure[parent::tei:citeStructure]"
                 priority="1000"
                 mode="M30">
   ...
   <!--PATTERN schematron-constraint-tei_ms-link-linkTargets3-27-->
   <!--RULE -->
   <xsl:template match="tei:link" priority="1000" mode="M31">
   ...
   <!--PATTERN schematron-constraint-tei_ms-ab-abstractModel-structure-ab-28-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-ab-abstractModel-structure-l-29-->
   <!--RULE -->
   <xsl:template match="tei:ab" priority="1000" mode="M33">
   ...
   <!--PATTERN schematron-constraint-tei_ms-join-joinTargets3-30-->
   <!--RULE -->
   <xsl:template match="tei:join" priority="1000" mode="M34">
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-standOff-nested_standOff_should_be_typed-31-->
   <!--RULE -->
   <xsl:template match="tei:standOff" priority="1000" mode="M35">
   ...
   <!--PATTERN schematron-constraint-tei_ms-div-abstractModel-structure-l-34-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-div-abstractModel-structure-p-35-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-relation-reforkeyorname-36-->
   <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M38">
   ...
   <!--PATTERN schematron-constraint-tei_ms-relation-activemutual-37-->
   <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M39">
   ...
   <!--PATTERN schematron-constraint-tei_ms-relation-activepassive-38-->
   <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M40">
   ...
   <!--PATTERN schematron-constraint-tei_ms-objectIdentifier-objectIdentifier_minimal-39-->
   <!--RULE -->
   <xsl:template match="tei:objectIdentifier" priority="1000" mode="M41">
   ...
   <!--PATTERN schematron-constraint-tei_ms-path-pathmustnotbeclosed-40-->
   <!--RULE -->
   <xsl:template match="tei:path[@points]" priority="1000" mode="M42">
   ...
   <!--PATTERN schematron-constraint-tei_ms-addSpan-spanTo-41-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-damageSpan-spanTo-43-->
   <!--RULE -->
...
The @spanTo attribute of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-delSpan-spanTo-45-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-subst-substContents1-47-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_ms-catchwords-catchword_in_msDesc-48-->
   <!--RULE -->
   <xsl:template match="tei:catchwords" priority="1000" mode="M47">
   ...
   <!--PATTERN schematron-constraint-tei_ms-dimensions-duplicateDim-49-->
   <!--RULE -->
   <xsl:template match="tei:dimensions" priority="1000" mode="M48">
...
The element <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_ms-secFol-secFol_in_msDesc-50-->
   <!--RULE -->
   <xsl:template match="tei:secFol" priority="1000" mode="M49">
   ...
   <!--PATTERN schematron-constraint-tei_ms-signatures-signatures_in_msDesc-51-->
   <!--RULE -->
   <xsl:template match="tei:signatures" priority="1000" mode="M50">
   ...
   <!--PATTERN schematron-constraint-tei_ms-msIdentifier-msId_minimal-52-->
   <!--RULE -->
