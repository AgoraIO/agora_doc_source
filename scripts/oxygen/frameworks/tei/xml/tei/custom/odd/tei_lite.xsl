...
<xsl:stylesheet xmlns:dcr="http://www.isocat.org/ns/dcr"
   ...
   <!--SCHEMATRON PATTERNS-->
   <!--PATTERN schematron-constraint-tei_lite-att.datable.w3c-att-datable-w3c-when-1-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_lite-att.datable.w3c-att-datable-w3c-from-2-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_lite-att.datable.w3c-att-datable-w3c-to-3-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_lite-att.typed-subtypeTyped-4-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_lite-att.pointing-targetLang-targetLang-5-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_lite-att.spanning-spanTo-spanTo-2-6-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_lite-p-abstractModel-structure-p-7-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_lite-p-abstractModel-structure-l-8-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_lite-desc-deprecationInfo-only-in-deprecated-9-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_lite-ptr-ptrAtts-10-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_lite-ref-refAtts-11-->
   <!--RULE -->
   <xsl:template match="tei:ref" priority="1000" mode="M15">
   ...
   <!--PATTERN schematron-constraint-tei_lite-list-gloss-list-must-have-labels-12-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_lite-relatedItem-targetorcontent1-13-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_lite-l-abstractModel-structure-l-14-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_lite-lg-atleast1oflggapl-15-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_lite-lg-abstractModel-structure-l-16-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_lite-div-abstractModel-structure-l-19-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_lite-div-abstractModel-structure-p-20-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_lite-s-noNestedS-21-->
   <!--RULE -->
