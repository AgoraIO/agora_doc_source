...
<xsl:stylesheet xmlns:iso="http://purl.oclc.org/dsdl/schematron"
   ...
   <!--SCHEMATRON PATTERNS-->
   <!--PATTERN schematron-constraint-tei_its-att.datable.w3c-att-datable-w3c-when-1-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-att.datable.w3c-att-datable-w3c-from-2-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-att.datable.w3c-att-datable-w3c-to-3-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-att.datable-calendar-calendar-4-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-att.measurement-att-measurement-unitRef-5-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-att.typed-subtypeTyped-6-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-att.pointing-targetLang-targetLang-7-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-att.spanning-spanTo-spanTo-2-8-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_its-att.styleDef-schemeVersion-schemeVersionRequiresScheme-9-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-p-abstractModel-structure-p-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-p-abstractModel-structure-l-11-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-desc-deprecationInfo-only-in-deprecated-12-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-rt-target-rt-target-not-span-13-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-rt-from-rt-from-14-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-rt-to-rt-to-15-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-ptr-ptrAtts-16-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_its-ref-refAtts-17-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-list-gloss-list-must-have-labels-18-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-relatedItem-targetorcontent1-19-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_its-l-abstractModel-structure-l-20-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-lg-atleast1oflggapl-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-lg-abstractModel-structure-l-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-quotation-quotationContents-23-->
   <!--RULE -->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_its-citeStructure-delim-citestructure-inner-delim-24-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-citeStructure-match-citestructure-outer-match-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-citeStructure-match-citestructure-inner-match-26-->
   <!--RULE -->
   <xsl:template match="tei:citeStructure[parent::tei:citeStructure]"
                 priority="1000"
                 mode="M29">
   ...
   <!--PATTERN schematron-constraint-tei_its-div-abstractModel-structure-l-29-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_its-div-abstractModel-structure-p-30-->
   <!--RULE -->
