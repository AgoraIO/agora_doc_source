...
<xsl:stylesheet xmlns:esp-d2e69785="http://www.example.org/cannot/really/use/XInclude"
                xmlns:esp-d2e69837="http://www.example.org/cannot/really/use/XInclude"
   ...
   <!--PATTERN schematron-constraint-tei_customization-rt-target-rt-target-not-span-13-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-rt-from-rt-from-14-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-rt-to-rt-to-15-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-ptr-ptrAtts-16-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_customization-ref-refAtts-17-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-list-gloss-list-must-have-labels-18-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-relatedItem-targetorcontent1-19-->
   <!--RULE -->
   <xsl:template match="tei:relatedItem" priority="1000" mode="M28">
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_customization-citeStructure-delim-citestructure-inner-delim-20-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-citeStructure-match-citestructure-outer-match-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-citeStructure-match-citestructure-inner-match-22-->
   <!--RULE -->
   <xsl:template match="tei:citeStructure[parent::tei:citeStructure]"
                 priority="1000"
                 mode="M31">
   ...
   <!--PATTERN schematron-constraint-tei_customization-div-abstractModel-structure-l-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-div-abstractModel-structure-p-26-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-att.repeatable-MINandMAXoccurs-27-->
   <!--RULE -->
   <xsl:template match="*[ @minOccurs  and  @maxOccurs ]" priority="1001" mode="M34">
   ...
   <!--PATTERN schematron-constraint-tei_customization-att.identified-spec-in-module-28-->
   <!--RULE -->
...
should correspond to an existing module, via a moduleSpec or
   ...
   <!--PATTERN schematron-constraint-tei_customization-att.deprecated-validUntil-deprecation-two-month-warning-29-->
   <!--RULE -->
   <xsl:template match="tei:*[@validUntil]" priority="1000" mode="M36">
   ...
   <!--PATTERN schematron-constraint-tei_customization-att.deprecated-validUntil-deprecation-should-be-explained-30-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-moduleRef-if-url-then-prefix-31-->
   <!--RULE -->
   <xsl:template match="tei:moduleRef[ @url ]" priority="1000" mode="M38">
   ...
   <!--PATTERN schematron-constraint-tei_customization-moduleRef-no-duplicate-modules-32-->
   <!--RULE -->
   <xsl:template match="tei:moduleRef[ @key ]" priority="1000" mode="M39">
   ...
   <!--PATTERN schematron-constraint-tei_customization-moduleRef-need-required-33-->
   <!--RULE -->
   <xsl:template match="tei:moduleRef[ @except ]" priority="1000" mode="M40">
   ...
   <!--PATTERN schematron-constraint-tei_customization-moduleRef-include-required-34-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-moduleRef-element-is-in-module-35-->
   <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'header']" priority="1019" mode="M42">
   ...
   <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'core']" priority="1018" mode="M42">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'gaiji']" priority="1016" mode="M42">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'verse']" priority="1015" mode="M42">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'drama']" priority="1014" mode="M42">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'spoken']" priority="1013" mode="M42">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'transcr']" priority="1010" mode="M42">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'figures']" priority="1007" mode="M42">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'corpus']" priority="1006" mode="M42">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'linking']" priority="1005" mode="M42">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'iso-fs']" priority="1003" mode="M42">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'nets']" priority="1002" mode="M42">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--RULE -->
   <xsl:template match="tei:moduleRef[@key eq 'tagdocs']" priority="1000" mode="M42">
      <xsl:variable name="include" select="tokenize( normalize-space(@include),' ')"/>
      <xsl:variable name="except" select="tokenize( normalize-space(@except), ' ')"/>
      <!--ASSERT -->
      <xsl:choose>
   ...
   <!--PATTERN schematron-constraint-tei_customization-moduleRef-modref-36-->
   <!--RULE -->
   <xsl:template match="tei:moduleRef" priority="1000" mode="M43">
...
Child elements of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_customization-moduleRef-prefix-not-same-prefix-37-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-schemaSpec-required-modules-38-->
   <!--RULE -->
   <xsl:template match="tei:schemaSpec" priority="1000" mode="M45">
   ...
   <!--PATTERN schematron-constraint-tei_customization-schemaSpec-no-outside-specs-39-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-schemaSpec-only-one-schemaSpec-40-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-schemaSpec-deprecate_schemaSpec_in_bizarre_places-41-->
   <!--RULE -->
   <xsl:template match="tei:schemaSpec|teix:schemaSpec" priority="1000" mode="M48">
   ...
   <!--PATTERN schematron-constraint-tei_customization-elementSpec-module-except-when-add-42-->
   <!--RULE -->
   <xsl:template match="tei:elementSpec" priority="1000" mode="M49">
   ...
   <!--PATTERN schematron-constraint-tei_customization-elementSpec-only-1-per-43-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-elementSpec-dont-delete-required-44-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-elementSpec-content_when_adding-45-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-elementSpec-empty_when_deleting-46-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-elementSpec-add_implies_ns-47-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-elementSpec-child-constraint-based-on-mode-48-->
   <!--RULE -->
   <xsl:template match="tei:elementSpec[ @mode eq 'delete' ]"
                 priority="1001"
                 mode="M55">
   ...
   <!--PATTERN schematron-constraint-tei_customization-altIdent-altIdent-only-NCName-49-->
   <!--RULE -->
   <xsl:template match="tei:altIdent" priority="1000" mode="M56">
   ...
   <!--PATTERN schematron-constraint-tei_customization-model-no_dup_default_models-50-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-model-no_dup_models-51-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-modelSequence-no_outputs_nor_predicates_4_my_kids-52-->
   <!--RULE -->
   <xsl:template match="tei:modelSequence" priority="1000" mode="M59">
   ...
   <!--PATTERN schematron-constraint-tei_customization-sequence-sequencechilden-53-->
   <!--RULE -->
   <xsl:template match="tei:sequence" priority="1000" mode="M60">
   ...
   <!--PATTERN schematron-constraint-tei_customization-alternate-alternatechilden-54-->
   <!--RULE -->
   <xsl:template match="tei:alternate" priority="1000" mode="M61">
   ...
   <!--PATTERN schematron-constraint-tei_customization-constraintSpec-sch_no_more-55-->
   <!--RULE -->
   <xsl:template match="tei:constraintSpec" priority="1000" mode="M62">
   ...
   <!--PATTERN schematron-constraint-tei_customization-constraintSpec-isosch-56-->
   <!--RULE -->
   <xsl:template match="tei:constraintSpec" priority="1000" mode="M63">
   ...
   <!--PATTERN schematron-constraint-tei_customization-constraintSpec-needrules-57-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-attDef-attDefContents-58-->
   <!--RULE -->
   <xsl:template match="tei:attDef" priority="1000" mode="M65">
   ...
   <!--PATTERN schematron-constraint-tei_customization-attDef-noDefault4Required-59-->
   <!--RULE -->
   <xsl:template match="tei:attDef[@usage eq 'req']" priority="1000" mode="M66">
   ...
   <!--PATTERN schematron-constraint-tei_customization-attDef-defaultIsInClosedList-twoOrMore-60-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-attDef-defaultIsInClosedList-one-61-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_customization-dataRef-restrictDataFacet-62-->
   <!--RULE -->
   <xsl:template match="tei:dataRef[tei:dataFacet]" priority="1000" mode="M69">
   ...
   <!--PATTERN schematron-constraint-tei_customization-dataRef-restrictAttRestriction-63-->
   <!--RULE -->
   <xsl:template match="tei:dataRef[tei:dataFacet]" priority="1000" mode="M70">
   ...
   <!--PATTERN schematron-constraint-tei_customization-dataRef-restrictAttResctrictionName-64-->
   <!--RULE -->
   <xsl:template match="tei:dataRef" priority="1000" mode="M71">
   ...
   <!--PATTERN schematron-constraint-tei_customization-mode-child-sanity-65-->
   <!--RULE -->
   <xsl:template match="*[ @mode eq 'delete' ]" priority="1001" mode="M72">
   ...
   <!--PATTERN schematron-constraint-tei_customization-tei-source-66-->
   <!--RULE -->
