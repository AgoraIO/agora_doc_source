...
<xsl:stylesheet xmlns:dcr="http://www.isocat.org/ns/dcr"
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.datable-calendar-calendar-4-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.spanning-spanTo-spanTo-2-8-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-p-abstractModel-structure-p-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-p-abstractModel-structure-l-11-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-desc-deprecationInfo-only-in-deprecated-12-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-rt-target-rt-target-not-span-13-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-rt-from-rt-from-14-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-rt-to-rt-to-15-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-ptr-ptrAtts-16-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-ref-refAtts-17-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-list-gloss-list-must-have-labels-18-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-relatedItem-targetorcontent1-19-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_odds-l-abstractModel-structure-l-20-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-lg-atleast1oflggapl-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-lg-abstractModel-structure-l-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-quotation-quotationContents-23-->
   <!--RULE -->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-citeStructure-delim-citestructure-inner-delim-24-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-citeStructure-match-citestructure-outer-match-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-citeStructure-match-citestructure-inner-match-26-->
   <!--RULE -->
   <xsl:template match="tei:citeStructure[parent::tei:citeStructure]"
                 priority="1000"
                 mode="M34">
   ...
   <!--PATTERN schematron-constraint-tei_odds-div-abstractModel-structure-l-29-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-div-abstractModel-structure-p-30-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.repeatable-MINandMAXoccurs-31-->
   <!--RULE -->
   <xsl:template match="*[ @minOccurs  and  @maxOccurs ]" priority="1001" mode="M37">
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.identified-spec-in-module-32-->
   <!--RULE -->
...
should correspond to an existing module, via a moduleSpec or
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.deprecated-validUntil-deprecation-two-month-warning-33-->
   <!--RULE -->
   <xsl:template match="tei:*[@validUntil]" priority="1000" mode="M39">
   ...
   <!--PATTERN schematron-constraint-tei_odds-att.deprecated-validUntil-deprecation-should-be-explained-34-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-moduleRef-modref-35-->
   <!--RULE -->
   <xsl:template match="tei:moduleRef" priority="1000" mode="M41">
...
Child elements of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-moduleRef-prefix-not-same-prefix-36-->
   <!--RULE -->
   <xsl:template match="tei:moduleRef" priority="1000" mode="M42">
   ...
   <!--PATTERN schematron-constraint-tei_odds-schemaSpec-deprecate_schemaSpec_in_bizarre_places-37-->
   <!--RULE -->
   <xsl:template match="tei:schemaSpec|teix:schemaSpec" priority="1000" mode="M43">
   ...
   <!--PATTERN schematron-constraint-tei_odds-elementSpec-child-constraint-based-on-mode-38-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-model-no_dup_default_models-39-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-model-no_dup_models-40-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-modelSequence-no_outputs_nor_predicates_4_my_kids-41-->
   <!--RULE -->
   <xsl:template match="tei:modelSequence" priority="1000" mode="M47">
   ...
   <!--PATTERN schematron-constraint-tei_odds-sequence-sequencechilden-42-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-alternate-alternatechilden-43-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-constraintSpec-sch_no_more-44-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-constraintSpec-isosch-45-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-constraintSpec-needrules-46-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-attDef-attDefContents-47-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-attDef-noDefault4Required-48-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-attDef-defaultIsInClosedList-twoOrMore-49-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-attDef-defaultIsInClosedList-one-50-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-dataRef-restrictDataFacet-51-->
   <!--RULE -->
   <xsl:template match="tei:dataRef[tei:dataFacet]" priority="1000" mode="M57">
   ...
   <!--PATTERN schematron-constraint-tei_odds-dataRef-restrictAttRestriction-52-->
   <!--RULE -->
   <xsl:template match="tei:dataRef[tei:dataFacet]" priority="1000" mode="M58">
   ...
   <!--PATTERN schematron-constraint-tei_odds-dataRef-restrictAttResctrictionName-53-->
   <!--RULE -->
   <xsl:template match="tei:dataRef" priority="1000" mode="M59">
   ...
   <!--PATTERN schematron-constraint-tei_odds-link-linkTargets3-54-->
   <!--RULE -->
   <xsl:template match="tei:link" priority="1000" mode="M60">
   ...
   <!--PATTERN schematron-constraint-tei_odds-ab-abstractModel-structure-ab-55-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_odds-ab-abstractModel-structure-l-56-->
   <!--RULE -->
   <xsl:template match="tei:ab" priority="1000" mode="M62">
   ...
   <!--PATTERN schematron-constraint-tei_odds-join-joinTargets3-57-->
   <!--RULE -->
   <xsl:template match="tei:join" priority="1000" mode="M63">
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_odds-standOff-nested_standOff_should_be_typed-58-->
   <!--RULE -->
   <xsl:template match="tei:standOff" priority="1000" mode="M64">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:value" priority="1000" mode="M65">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:unicodeName" priority="1000" mode="M66">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:localName" priority="1000" mode="M67">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:glyphName" priority="1000" mode="M68">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:charProp" priority="1000" mode="M69">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:charName" priority="1000" mode="M70">
