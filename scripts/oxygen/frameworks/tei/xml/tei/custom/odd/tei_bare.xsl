...
<xsl:stylesheet xmlns:iso="http://purl.oclc.org/dsdl/schematron"
   ...
   <!--SCHEMATRON PATTERNS-->
   <!--PATTERN schematron-constraint-tei_bare-att.datable.w3c-att-datable-w3c-when-1-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_bare-att.datable.w3c-att-datable-w3c-from-2-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_bare-att.datable.w3c-att-datable-w3c-to-3-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_bare-att.datable-calendar-calendar-4-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_bare-att.typed-subtypeTyped-5-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_bare-p-abstractModel-structure-p-6-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_bare-p-abstractModel-structure-l-7-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_bare-list-gloss-list-must-have-labels-8-->
   <!--RULE -->
   <xsl:template match="tei:list[@type='gloss']" priority="1000" mode="M11">
   ...
   <!--PATTERN schematron-constraint-tei_bare-div-abstractModel-structure-l-11-->
   <!--RULE -->
   <xsl:template match="tei:div" priority="1000" mode="M12">
   ...
   <!--PATTERN schematron-constraint-tei_bare-div-abstractModel-structure-p-12-->
   <!--RULE -->
   <xsl:template match="tei:div" priority="1000" mode="M13">
