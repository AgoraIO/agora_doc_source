...
<xsl:stylesheet xmlns:dcr="http://www.isocat.org/ns/dcr"
   ...
   <!--SCHEMATRON PATTERNS-->
   <!--PATTERN schematron-constraint-tei_corpus-att.datable.w3c-att-datable-w3c-when-1-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-att.datable.w3c-att-datable-w3c-from-2-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-att.datable.w3c-att-datable-w3c-to-3-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-att.datable-calendar-calendar-4-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-att.measurement-att-measurement-unitRef-5-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-att.typed-subtypeTyped-6-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-att.pointing-targetLang-targetLang-7-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-att.spanning-spanTo-spanTo-2-8-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_corpus-att.styleDef-schemeVersion-schemeVersionRequiresScheme-9-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-p-abstractModel-structure-p-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-p-abstractModel-structure-l-11-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-desc-deprecationInfo-only-in-deprecated-12-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-rt-target-rt-target-not-span-13-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-rt-from-rt-from-14-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-rt-to-rt-to-15-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-ptr-ptrAtts-16-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_corpus-ref-refAtts-17-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-list-gloss-list-must-have-labels-18-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-relatedItem-targetorcontent1-19-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_corpus-l-abstractModel-structure-l-20-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-lg-atleast1oflggapl-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-lg-abstractModel-structure-l-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-quotation-quotationContents-23-->
   <!--RULE -->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_corpus-citeStructure-delim-citestructure-inner-delim-24-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-citeStructure-match-citestructure-outer-match-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-citeStructure-match-citestructure-inner-match-26-->
   <!--RULE -->
   <xsl:template match="tei:citeStructure[parent::tei:citeStructure]"
                 priority="1000"
                 mode="M30">
   ...
   <!--PATTERN schematron-constraint-tei_corpus-div-abstractModel-structure-l-29-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-div-abstractModel-structure-p-30-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-relation-reforkeyorname-31-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-relation-activemutual-32-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-relation-activepassive-33-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-objectIdentifier-objectIdentifier_minimal-34-->
   <!--RULE -->
   <xsl:template match="tei:objectIdentifier" priority="1000" mode="M36">
   ...
   <!--PATTERN schematron-constraint-tei_corpus-link-linkTargets3-35-->
   <!--RULE -->
   <xsl:template match="tei:link" priority="1000" mode="M37">
   ...
   <!--PATTERN schematron-constraint-tei_corpus-ab-abstractModel-structure-ab-36-->
   <!--RULE -->
   <xsl:template match="tei:ab" priority="1000" mode="M38">
   ...
   <!--PATTERN schematron-constraint-tei_corpus-ab-abstractModel-structure-l-37-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_corpus-join-joinTargets3-38-->
   <!--RULE -->
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_corpus-standOff-nested_standOff_should_be_typed-39-->
   <!--RULE -->
   <xsl:template match="tei:standOff" priority="1000" mode="M41">
