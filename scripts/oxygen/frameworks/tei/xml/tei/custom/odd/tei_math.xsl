...
<xsl:stylesheet xmlns:iso="http://purl.oclc.org/dsdl/schematron"
   ...
   <!--SCHEMATRON PATTERNS-->
   <!--PATTERN schematron-constraint-tei_math-att.datable.w3c-att-datable-w3c-when-1-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_math-att.datable.w3c-att-datable-w3c-from-2-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_math-att.datable.w3c-att-datable-w3c-to-3-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_math-att.datable-calendar-calendar-4-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_math-att.measurement-att-measurement-unitRef-5-->
   <!--RULE -->
   <xsl:template match="tei:*[@unitRef]" priority="1000" mode="M8">
   ...
   <!--PATTERN schematron-constraint-tei_math-att.typed-subtypeTyped-6-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_math-att.pointing-targetLang-targetLang-7-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_math-att.spanning-spanTo-spanTo-2-8-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_math-att.styleDef-schemeVersion-schemeVersionRequiresScheme-9-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_math-p-abstractModel-structure-p-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_math-p-abstractModel-structure-l-11-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_math-desc-deprecationInfo-only-in-deprecated-12-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_math-rt-target-rt-target-not-span-13-->
   <!--RULE -->
   <xsl:template match="tei:rt/@target" priority="1000" mode="M16">
   ...
   <!--PATTERN schematron-constraint-tei_math-rt-from-rt-from-14-->
   <!--RULE -->
   <xsl:template match="tei:rt/@from" priority="1000" mode="M17">
   ...
   <!--PATTERN schematron-constraint-tei_math-rt-to-rt-to-15-->
   <!--RULE -->
   <xsl:template match="tei:rt/@to" priority="1000" mode="M18">
   ...
   <!--PATTERN schematron-constraint-tei_math-ptr-ptrAtts-16-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_math-ref-refAtts-17-->
   <!--RULE -->
   <xsl:template match="tei:ref" priority="1000" mode="M20">
   ...
   <!--PATTERN schematron-constraint-tei_math-list-gloss-list-must-have-labels-18-->
   <!--RULE -->
   <xsl:template match="tei:list[@type='gloss']" priority="1000" mode="M21">
   ...
   <!--PATTERN schematron-constraint-tei_math-relatedItem-targetorcontent1-19-->
   <!--RULE -->
   <xsl:template match="tei:relatedItem" priority="1000" mode="M22">
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_math-l-abstractModel-structure-l-20-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_math-lg-atleast1oflggapl-21-->
   <!--RULE -->
   <xsl:template match="tei:lg" priority="1000" mode="M24">
   ...
   <!--PATTERN schematron-constraint-tei_math-lg-abstractModel-structure-l-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_math-quotation-quotationContents-23-->
   <!--RULE -->
   <xsl:template match="tei:quotation" priority="1000" mode="M26">
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_math-citeStructure-delim-citestructure-inner-delim-24-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_math-citeStructure-match-citestructure-outer-match-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_math-citeStructure-match-citestructure-inner-match-26-->
   <!--RULE -->
   <xsl:template match="tei:citeStructure[parent::tei:citeStructure]"
                 priority="1000"
                 mode="M29">
   ...
   <!--PATTERN schematron-constraint-tei_math-div-abstractModel-structure-l-29-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_math-div-abstractModel-structure-p-30-->
   <!--RULE -->
