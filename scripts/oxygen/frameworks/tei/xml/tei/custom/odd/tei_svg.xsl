...
<xsl:stylesheet xmlns:dcr="http://www.isocat.org/ns/dcr"
   ...
   <!--SCHEMATRON PATTERNS-->
   <!--PATTERN schematron-constraint-tei_svg-att.datable.w3c-att-datable-w3c-when-1-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-att.datable.w3c-att-datable-w3c-from-2-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-att.datable.w3c-att-datable-w3c-to-3-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-att.datable-calendar-calendar-4-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-att.measurement-att-measurement-unitRef-5-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-att.typed-subtypeTyped-6-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-att.pointing-targetLang-targetLang-7-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-att.spanning-spanTo-spanTo-2-8-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-att.styleDef-schemeVersion-schemeVersionRequiresScheme-9-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-p-abstractModel-structure-p-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-p-abstractModel-structure-l-11-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-desc-deprecationInfo-only-in-deprecated-12-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-rt-target-rt-target-not-span-13-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-rt-from-rt-from-14-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-rt-to-rt-to-15-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-ptr-ptrAtts-16-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-ref-refAtts-17-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-list-gloss-list-must-have-labels-18-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-relatedItem-targetorcontent1-19-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_svg-l-abstractModel-structure-l-20-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-lg-atleast1oflggapl-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-lg-abstractModel-structure-l-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-quotation-quotationContents-23-->
   <!--RULE -->
...
On <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-citeStructure-delim-citestructure-inner-delim-24-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-citeStructure-match-citestructure-outer-match-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-citeStructure-match-citestructure-inner-match-26-->
   <!--RULE -->
   <xsl:template match="tei:citeStructure[parent::tei:citeStructure]"
                 priority="1000"
                 mode="M30">
   ...
   <!--PATTERN schematron-constraint-tei_svg-div-abstractModel-structure-l-29-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-div-abstractModel-structure-p-30-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-link-linkTargets3-31-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-ab-abstractModel-structure-ab-32-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-ab-abstractModel-structure-l-33-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_svg-join-joinTargets3-34-->
   <!--RULE -->
...
You must supply at least two values for @target on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_svg-standOff-nested_standOff_should_be_typed-35-->
   <!--RULE -->
