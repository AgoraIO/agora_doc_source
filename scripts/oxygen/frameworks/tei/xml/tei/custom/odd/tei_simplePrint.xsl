...
<xsl:stylesheet xmlns:iso="http://purl.oclc.org/dsdl/schematron"
   ...
   <!--SCHEMATRON PATTERNS-->
   <!--PATTERN schematron-constraint-tei_simplePrint-att.datable.w3c-att-datable-w3c-when-1-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-att.datable.w3c-att-datable-w3c-from-2-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-att.datable.w3c-att-datable-w3c-to-3-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-att.datable-calendar-calendar-4-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-att.global.rendition-renditionpointer-5-->
   <!--RULE -->
   <xsl:template match="tei:*[@rendition]" priority="1000" mode="M8">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message> Error: Each of the rendition
                      values in "<xsl:text/>
               <xsl:value-of select="@rendition"/>
               <xsl:text/>" must point to a local ID or to a
                      token in the Simple scheme (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-att.global.rendition-corresppointer-6-->
   <!--RULE -->
   <xsl:template match="tei:*[@corresp]" priority="1000" mode="M9">
      <xsl:variable name="results"
      ...
      <xsl:if test="some $x in $results  satisfies $x">
         <xsl:message> Error: Every local pointer in
                        "<xsl:text/>
            <xsl:value-of select="@corresp"/>
            <xsl:text/>" must point to an ID in this document
                        (<xsl:text/>
            <xsl:value-of select="$results"/>
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-att.measurement-att-measurement-unitRef-7-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-att.typed-subtypeTyped-8-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-att.pointing-targetLang-targetLang-9-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-att.pointing-target-validtarget-10-->
   <!--RULE -->
   <xsl:template match="tei:*[@target]" priority="1000" mode="M13">
      ...
      <!--REPORT -->
      <xsl:if test="some $x in $results  satisfies $x">
         <xsl:message> Error: Every local pointer
                          in "<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-att.spanning-spanTo-spanTo-2-11-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-att.styleDef-schemeVersion-schemeVersionRequiresScheme-12-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-ab-abstractModel-structure-ab-13-->
   <!--RULE -->
   <xsl:template match="tei:ab" priority="1000" mode="M16">
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-ab-abstractModel-structure-l-14-->
   <!--RULE -->
   <xsl:template match="tei:ab" priority="1000" mode="M17">
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-bibl-noEmptyBibl-15-->
   <!--RULE -->
   <xsl:template match="tei:bibl" priority="1000" mode="M18">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message> Element
                    "<xsl:text/>
               <xsl:value-of select="name(.)"/>
               <xsl:text/>" may not be empty.  (child::* or child::text()[normalize-space()] / ERROR)</xsl:message>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M18"/>
   </xsl:template>
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-choice-choiceSize-16-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-choice-choiceContent-17-->
   <!--RULE -->
   <xsl:template match="tei:choice" priority="1000" mode="M20">
      ...
      <xsl:choose>
         ...
         <xsl:otherwise>
            <xsl:message> Element "<xsl:text/>
               <xsl:value-of select="name(.)"/>
               <xsl:text/>" must have corresponding corr/sic, expand/abbr,
                    reg/orig  ((tei:corr or tei:sic or tei:expan or tei:abbr or tei:reg or tei:orig) and ((tei:corr and tei:sic) or (tei:expan and tei:abbr) or (tei:reg and tei:orig)) / ERROR)</xsl:message>
         </xsl:otherwise>
      </xsl:choose>
      <xsl:apply-templates select="*" mode="M20"/>
   </xsl:template>
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-desc-deprecationInfo-only-in-deprecated-18-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-div-abstractModel-structure-l-19-->
   <!--RULE -->
   <xsl:template match="tei:div" priority="1000" mode="M22">
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-div-abstractModel-structure-p-20-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-l-abstractModel-structure-l-21-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-lg-atleast1oflggapl-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-lg-abstractModel-structure-l-23-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-list-gloss-list-must-have-labels-24-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-p-abstractModel-structure-p-25-->
   <!--RULE -->
   <xsl:template match="tei:p" priority="1000" mode="M28">
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-p-abstractModel-structure-l-26-->
   <!--RULE -->
   <xsl:template match="tei:p" priority="1000" mode="M29">
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-ref-refAtts-27-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-relatedItem-targetorcontent1-28-->
   <!--RULE -->
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-s-noNestedS-29-->
   <!--RULE -->
   <xsl:template match="tei:s" priority="1000" mode="M32">
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-subst-substContents1-30-->
   <!--RULE -->
   <xsl:template match="tei:subst" priority="1000" mode="M33">
   ...
   <!--PATTERN schematron-constraint-tei_simplePrint-text-headeronlyelement-33-->
   <!--RULE -->
   <xsl:template match="tei:term | tei:biblFull " priority="1000" mode="M34">

		<!--REPORT -->
      <xsl:if test="ancestor::tei:text">
         <xsl:message>Error: The element <xsl:text/>
            <xsl:value-of select="name(.)"/>
            <xsl:text/> is not permitted
                      outside the header (ancestor::tei:text)</xsl:message>
      </xsl:if>
      <xsl:apply-templates select="*" mode="M34"/>
   </xsl:template>
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:glyphName" priority="1000" mode="M35">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:charName" priority="1000" mode="M36">
