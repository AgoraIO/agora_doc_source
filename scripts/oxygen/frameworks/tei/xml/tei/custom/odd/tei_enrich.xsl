...
<xsl:stylesheet xmlns:dcr="http://www.isocat.org/ns/dcr"
   ...
   <!--PATTERN schematron-constraint-tei_enrich-att.datable-calendar-calendar-4-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-att.spanning-spanTo-spanTo-2-8-->
   <!--RULE -->
...
The element indicated by @spanTo (<xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_enrich-p-abstractModel-structure-p-10-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-p-abstractModel-structure-l-11-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-desc-deprecationInfo-only-in-deprecated-12-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-rt-target-rt-target-not-span-13-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-rt-from-rt-from-14-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-rt-to-rt-to-15-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-date-dates-16-->
   <!--RULE -->
   <xsl:template match="tei:date" priority="1000" mode="M20">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-ptr-ptrAtts-17-->
   <!--RULE -->
...
attributes @target and @cRef may be supplied on <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_enrich-ref-refAtts-18-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-list-gloss-list-must-have-labels-19-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-relatedItem-targetorcontent1-20-->
   <!--RULE -->
   <xsl:template match="tei:relatedItem" priority="1000" mode="M24">
...
relatedItem element must be empty (@target and count( child::* ) &gt; 0)</xsl:message>
   ...
   <!--PATTERN schematron-constraint-tei_enrich-l-abstractModel-structure-l-21-->
   <!--RULE -->
   <xsl:template match="tei:l" priority="1000" mode="M25">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-lg-atleast1oflggapl-22-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-lg-abstractModel-structure-l-23-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-citeStructure-delim-citestructure-inner-delim-24-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-citeStructure-match-citestructure-outer-match-25-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-citeStructure-match-citestructure-inner-match-26-->
   <!--RULE -->
   <xsl:template match="tei:citeStructure[parent::tei:citeStructure]"
                 priority="1000"
                 mode="M30">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-div-abstractModel-structure-l-29-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-div-abstractModel-structure-p-30-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-catchwords-catchword_in_msDesc-31-->
   <!--RULE -->
   <xsl:template match="tei:catchwords" priority="1000" mode="M33">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-dimensions-duplicateDim-32-->
   <!--RULE -->
   <xsl:template match="tei:dimensions" priority="1000" mode="M34">
...
The element <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_enrich-secFol-secFol_in_msDesc-33-->
   <!--RULE -->
   <xsl:template match="tei:secFol" priority="1000" mode="M35">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-signatures-signatures_in_msDesc-34-->
   <!--RULE -->
   <xsl:template match="tei:signatures" priority="1000" mode="M36">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-msIdentifier-msId_minimal-35-->
   <!--RULE -->
   <xsl:template match="tei:msIdentifier" priority="1000" mode="M37">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-standOff-nested_standOff_should_be_typed-36-->
   <!--RULE -->
   <xsl:template match="tei:standOff" priority="1000" mode="M38">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-relation-reforkeyorname-37-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-relation-activemutual-38-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-relation-activepassive-39-->
   <!--RULE -->
   <xsl:template match="tei:relation" priority="1000" mode="M41">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-objectIdentifier-objectIdentifier_minimal-40-->
   <!--RULE -->
   <xsl:template match="tei:objectIdentifier" priority="1000" mode="M42">
   ...
   <!--PATTERN schematron-constraint-tei_enrich-path-pathmustnotbeclosed-41-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-addSpan-spanTo-42-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-damageSpan-spanTo-44-->
   <!--RULE -->
...
The @spanTo attribute of <xsl:text/>
   ...
   <!--PATTERN schematron-constraint-tei_enrich-delSpan-spanTo-46-->
   <!--RULE -->
   ...
   <!--PATTERN schematron-constraint-tei_enrich-subst-substContents1-48-->
   <!--RULE -->
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:value" priority="1000" mode="M48">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:unicodeName" priority="1000" mode="M49">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:localName" priority="1000" mode="M50">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:glyphName" priority="1000" mode="M51">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:charProp" priority="1000" mode="M52">
   ...
   <!--PATTERN -->
   <!--RULE -->
   <xsl:template match="tei:charName" priority="1000" mode="M53">
