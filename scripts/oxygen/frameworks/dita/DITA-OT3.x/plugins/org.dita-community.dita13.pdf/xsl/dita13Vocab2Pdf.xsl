<?xml version="1.0" encoding="UTF-8"?><xsl:stylesheet xmlns:relpath="http://dita2indesign/functions/relpath" xmlns:xd="http://www.oxygenxml.com/ns/doc/xsl" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="xs xd relpath" version="2.0">
  <!-- =====================================================
