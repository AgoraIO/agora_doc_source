<?xml version="1.0" encoding="UTF-8"?><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="2.0" exclude-result-prefixes="#all">

    <xsl:import href="merged-all.xsl"/>
    
    <!-- XSLT extension point for the DITA merged file post-processing, before entering other phases. -->
    <xsl:import xmlns:dita="http://dita-ot.sourceforge.net" href="plugin:com.oxygenxml.editlink:pdf-css.xsl"/>
