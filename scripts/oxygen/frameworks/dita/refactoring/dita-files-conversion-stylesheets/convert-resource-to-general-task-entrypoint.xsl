...
<xsl:stylesheet
    ...
    <xsl:variable name="public-literal-target" select="'-//OASIS//DTD DITA General Task//EN'"/>
    <xsl:variable name="system-literal-target" select="'generalTask.dtd'"/>
    ...
    <xsl:variable
        ...
        select="'urn:oasis:names:tc:dita:xsd:task.xsd'"/>
    <xsl:variable
        name="xml-model-location"
        select="'urn:oasis:names:tc:dita:rng:generalTask.rng'"/>
