...
<xsl:stylesheet
    ...
    <xsl:import href="convert-resource-to-troubleshooting-custom.xsl"/>
    <xsl:import href="handle-convert-to-self.xsl"/>

    <xsl:variable name="root-element" select="'troubleshooting'"/>
    <xsl:variable name="public-literal-target" select="'-//OASIS//DTD DITA Troubleshooting//EN'"/>
    <xsl:variable name="system-literal-target" select="'troubleshooting.dtd'"/>
    ...
    <xsl:variable
        ...
        select="'urn:oasis:names:tc:dita:xsd:troubleshooting.xsd'"/>
    <xsl:variable
        name="xml-model-location"
        select="'urn:oasis:names:tc:dita:rng:troubleshooting.rng'"/>
