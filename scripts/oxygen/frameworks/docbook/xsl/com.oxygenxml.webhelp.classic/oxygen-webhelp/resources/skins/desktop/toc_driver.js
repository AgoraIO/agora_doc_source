...
function loadSearchResources() {
    if (typeof window.indexerLanguage == 'undefined') {
        var scripts = ["oxygen-webhelp/search/htmlFileInfoList.js?uniqueId=@@WEBHELP_UNIQUE_ID@@", "oxygen-webhelp/search/index-1.js?uniqueId=@@WEBHELP_UNIQUE_ID@@", "oxygen-webhelp/search/index-2.js?uniqueId=@@WEBHELP_UNIQUE_ID@@", "oxygen-webhelp/search/index-3.js?uniqueId=@@WEBHELP_UNIQUE_ID@@"];
