...
<![%set.element;[
<!--doc:A Set is a collection of Books. Placing multiple Books in a Set, as opposed to publishing each of them separately, has the advantage that ID/IDREF links can then be used across all books. Set is the very top of the DocBook structural hierarchy. There's nothing that contains a Set.
Category: Components-->
...
A Colophon, if present, almost always occurs at the very end of a book. It contains factual information about the book, especially about its production, and includes details about typographic style, the fonts used, the paper used, and perhaps the binding method of the book. Font geeks like Norm think every book should have one.
Category: Components-->
...
<![%toc.element;[
<!--doc:The ToC element defines a table of contents in a document. The general structure of elements in a ToC is analogous to the structure of the document described. For example, a ToC for a Book might contain TocFront elements for the front-matter of the book, TocChap elements for the body of the book, and TocBack elements for the back matter. Inside each of these are additional elements reflecting the structure of each component.
Category: tocs-->
...
The ToCfront element is a chapter-level ToC element for front matter such as Prefaces.-->
...
The ToCchap element is a chapter-level ToC element for components in the main body of a document.-->
...
The ToClevel1 element is a ToC entry for a first-level section in a component.-->
...
The ToClevel2 element is a ToC entry for a second-level section in a component.-->
...
The ToClevel3 element is a ToC entry for a third-level section in a component.-->
...
The ToClevel4 element is a ToC entry for a fourth-level section in a component.-->
...
The ToClevel5 element is a ToC entry for a fifth-level section in a component. The ToC machinery in DocBook has not been extended to handle the infinitely recursive nature of Sections. It may never be extended.-->
...
The ToCback element is a chapter-level ToC element for back matter (Bibliographys, Indexs, and so on).-->
...
A LoTentry identifies an individual title in a LoT. For example, in a list of figures, each individual figure title would be repeated in a LoTentry in the LoT for the list of figures.-->
...
Preface is a preface or forward in a Book. ThePreface element may appear more than once and should be used for all introductory chapter-like material. For example, a Book might have both a Foreward and an Introduction. Both should be tagged as Prefaces in DocBook.
Category: Components-->
...
A Reference is a collection of RefEntrys. In a Book, a Reference can occur at either the Part or Chapter level. Reference pages are usually bound together by topic; in traditional UNIX documentation they are most frequently bound into volumes. See ManVolNum.-->
...
PartIntro contains introductory text, often an overview of the content of the Part.
Category: Components-->
...
The AppendixInfo element is a wrapper for a large collection of meta-information about a Appendix. Much of this data is bibliographic in nature.
Category: Meta-wrappers-->
...
The BibliographyInfo element is a wrapper for a large collection of meta-information about a Bibliography. Much of this data is bibliographic in nature.
Category: Meta-wrappers-->
...
The ChapterInfo element is a wrapper for a large collection of meta-information about a Chapter. Much of this data is bibliographic in nature.
Category: Meta-wrappers-->
...
The GlossaryInfo element is a wrapper for a large collection of meta-information about a Glossary. Much of this data is bibliographic in nature.
Category: Meta-wrappers-->
...
The IndexInfo element is a wrapper for a large collection of meta-information about a Index. Much of this data is bibliographic in nature.
Category: Meta-wrappers-->
...
The SetIndexInfo element is a wrapper for a large collection of meta-information about a SetIndex. Much of this data is bibliographic in nature.-->
...
The PartInfo element is a wrapper for a large collection of meta-information about a Part. Much of this data is bibliographic in nature.-->
...
The PrefaceInfo element is a wrapper for a large collection of meta-information about a Preface. Much of this data is bibliographic in nature.
Category: Meta-wrappers-->
...
The RefentryInfo element is a wrapper for a large collection of meta-information about a Refentry. Much of this data is bibliographic in nature.-->
...
Like the other info elements,refsectioninfo contains meta-information about the section of the document in which it occurs.-->
...
Like the other “info” elements, RefSect1Info contains meta-information about the section of the document in which it occurs.-->
...
Like the other “info” elements, RefSect3Info contains meta-information about the section of the document in which it occurs.-->
...
Like the other “info” elements,RefSynopsisDivInfo contains meta-information about the section of the document in which it occurs.
Category: Meta-wrappers-->
...
The ReferenceInfo element is a wrapper for a large collection of meta-information about a Reference. Much of this data is bibliographic in nature.-->
...
Like the other “info” elements, Sect2Info contains meta-information about the section of the document in which it occurs.
Category: Meta-wrappers-->
...
Like the other “info” elements, Sect3Info contains meta-information about the section of the document in which it occurs.
Category: Meta-wrappers-->
...
Like the other “info” elements, Sect4Info contains meta-information about the section of the document in which it occurs.
Category: Meta-wrappers-->
...
Like the other “info” elements, Sect5Info contains meta-information about the section of the document in which it occurs.
Category: Meta-wrappers-->
...
Like the other “info” elements, SectionInfo contains meta-information about the section of the document in which it occurs.
Category: Meta-wrappers-->
...
A Sect5 is a fifth-level section in a document. This is the lowest-level numbered sectioning element. There is noSect6.
Category: Sections-->
...
<!--doc:A bibliography. A DocBook bibliography may contain some prefatory matter, but its main content is a set of bibliography entries (either BiblioEntry or BiblioMixed). These may occur inside BiblioDivs, instead of appearing directly in the Bibliograpy.-->
...
<![%bibliodiv.element;[
<!--doc:BiblioDiv is a section of a Bibliography. A bibliography might be divided into sections in order to group different types of sources together, like books, journal articles, web sites, and so on.A bibliography may contain any number of BiblioEntry or BiblioMixed elements or any number of BiblioDivs, but it cannot contain a mixture of both at the same level.-->
...
<![%glossary.element;[
<!--doc:A Glossary contains a collection of terms and brief descriptions or definitions of those terms.-->
...
A GlossDiv is a section of a Glossary. A Glossary might be divided into sections in order to group terms, perhaps alphabetically.A Glossary may contain any number of GlossEntry or GlossDiv elements, but it cannot contain a mixture of both at the same level.-->
...
<![%index.element;[
<!--doc:An Index contains the formatted index of a document. An index may begin with introductory material, followed by any number of IndexEntrys or IndexDivs.-->
...
An IndexDiv identifies a section of an Index. An index might be divided into sections in order to group entries, usually alphabetically.An index may contain any number of IndexEntry or IndexDiv elements, but it cannot contain a mixture of both at the same level.-->
...
PrimaryIE identifies the most significant word or words in an IndexEntry. IndexEntrys occur in an Index, not in the flow of the text. They are part of a formatted index, not markers for indexing. If a document includes both IndexTerms and IndexEntrys, the IndexEntrys are usually constructed from the IndexTerms by some external process.
Category: index terms-->
...
SecondaryIE identifies a secondary word or words in an IndexEntry. In IndexEntrys, you can specify as many secondary terms that are necessary. Secondary and tertiary terms can be mixed, following the primary.
Category: index terms-->
...
TertiaryIE identifies a third-level word or words in an IndexEntry. In IndexEntrys, you can specify as many tertiary terms that are necessary. Secondary and tertiary terms can be mixed, following the primary.
Category: index terms-->
...
SeeAlsoIE identifies a See also cross-reference in an IndexEntry. IndexEntrys occur in an Index, not in the flow of the text. They are part of a formatted index, not markers for indexing.
Category: index terms-->
...
RefMeta holds the title of the reference page, the number of the volume in which this reference page occurs, and possibly other miscellaneous information (typically used in printing the reference page).-->
...
RefNameDiv is the first mandatory section in a RefEntry. It is a peer to RefSynopsisDiv and RefSect1. The elements in RefNameDiv identify the topic of the reference page (RefDescriptor or RefName), provide a concise summary (RefPurpose), and classify the page (RefClass).
Category: refentry sections-->
...
Reference pages have their own hierarchical structure. A RefSection is a recursive division in a RefEntry, analogous to a Section elsewhere in the document. The value of a separate hierarchical structure is that it allows the content model of sections in reference pages to be customized differently than the content model of sections outside.
Category: refentry sections-->
...
A RefSect3 is a third level section in a RefEntry, analogous to a Sect3 elsewhere in the document. See RefSect1. In DocBook, RefSect3 is the lowest-level section allowed in a RefEntry. There is no element analogous to a Sect4.
Category: refentry sections-->
