            ...
            <body>
                ...
                <xsl:if
                    test="
                        ...
                        substitutionGroupAffiliation | usedBy | model | children | attributes | asserts | constraints | instance | source | publicid | systemid | schemaLocation) > 0">
                    <table frame="all" rowsep="1" colsep="1">
                        <tgroup cols="2">
                            <colspec colwidth="3*" align="left"/>
                            ...
                            <tbody>
                                ...
                                <xsl:apply-templates
                                    select="usedBy | model | children | attributes | typeAlternatives | asserts | constraints | instance | source"/>
                ...
                <p>
                    <table frame="all" rowsep="1" colsep="1">
                        <tgroup cols="5">
                            ...
                            <colspec colnum="2" colwidth="2*" align="left"/>
                            <colspec colnum="3" colwidth="2*" align="left"/>
                            <colspec colnum="4" colwidth="2*" align="left"/>
                            <colspec colnum="5" colwidth="2*" align="left"/>
                            <thead>
                                <row>
                                    <entry>QName</entry>
                                    <entry>Type</entry>
