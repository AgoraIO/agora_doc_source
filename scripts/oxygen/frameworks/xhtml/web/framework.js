...
sync.xhtml.XhtmlExtension.prototype.editorCreated = function(editor) {
  goog.events.listen(editor, sync.api.Editor.EventTypes.ACTIONS_LOADED, function(e) {
    ...
    var originalInsertWebLinkAction = editor.getActionsManager().getActionById(insertWebLinkActionId);
    if(originalInsertWebLinkAction) {
      ...
      editor.getActionsManager().registerAction(insertWebLinkActionId, insertWebLinkAction);
    }
