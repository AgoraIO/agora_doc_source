...
# (c) 2020 Syncro Soft SRL.
# Usage:
# sh translationPackageBuilder.sh -gm -i ditamapFile [-m milestoneFile] [-verbose]
# sh translationPackageBuilder.sh -gp -i ditamapFile [-m milestoneFile] -p package.zip [-verbose]
# sh translationPackageBuilder.sh -ap -i ditamapFile -p package.zip [-verbose]
