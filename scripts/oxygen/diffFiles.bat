...
rem  The two command line parameters are optional and represent the path of the file 
rem  displayed in the left side panel of the XML Diff window and the path of the file 
