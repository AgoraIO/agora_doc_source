...
# Classpath
CP=$OXYGEN_HOME/lib/oxygen-basic-utilities.jar:$OXYGEN_HOME/lib/oxygen.jar:$OXYGEN_HOME/lib/oxygenAuthor.jar:$OXYGEN_HOME/lib/oxygenDeveloper.jar:$OXYGEN_HOME/lib/syncroSVNClient.jar:$OXYGEN_HOME/classes:$OXYGEN_HOME
...
then
set -- \
 -Xdock:name="Syncro SVN Client"\
 -Xdock:icon="$OXYGEN_HOME/macOS.resources/SyncroSVNClient.icns"\
 "$@"
fi
