...
# Classpath
CP=$OXYGEN_HOME/lib/oxygen-basic-utilities.jar:$OXYGEN_HOME/lib/oxygen.jar:$OXYGEN_HOME/lib/oxygenAuthor.jar:$OXYGEN_HOME/classes:$OXYGEN_HOME
...
# repeatedly starting oxygenAuthor.sh. In this way you can open files by typing:
#    oxygenAuthor.sh File.xml 
...
then
set -- \
 -Xdock:name="Oxygen XML Author"\
 -Xdock:icon="$OXYGEN_HOME/macOS.resources/Author.icns"\
 "$@"
fi
