...
/**  Sets the video encoding profile manually.
 ...
 @param resolution Resolution of the video that you want to set. The highest value is 1280 x 720.
...
/**
 ...
 This method adds a watermark in the PNG file format onto the local video stream so that the recording device and the audience in the channel and CDN can see or capture it.
 To add the PNG file onto a CDN publishing stream only, see [setLiveTranscoding](setLiveTranscoding:).
...
/** Adds a stream URL.
 ...
 @param transcodingEnabled * True: Enable transcoding.
...
Adds a URL address of the added stream into the live broadcast channel.
 ...
 @param url URL address to be added into the ongoing live broadcast. You can use the RTMP, HLS, and FLV live streaming protocols and the MP3/MP4 streams.
