...
/** Generates a new Token.
 ...
 NOTE: To be compatible with previous versions, AgoraErrorCodeTokenExpired = 109 and AgoraErrorCodeInvalidToken = 110 are also reported through the [didOccurError](liveKit:didOccurError:) callback.
 You should move the renew token logic into this callback.
...
/** The SDK disconnected from the server.
 ...
 This event is reported when the SDK loses connection to the server.
...
/**  Allows a user to join a channel.
 ...
 The channel ID supported scope: a-z, A-Z, 0-9, space, !#$%&, ()+,-, :;<=., >?@[], ^_, {|}, ~
