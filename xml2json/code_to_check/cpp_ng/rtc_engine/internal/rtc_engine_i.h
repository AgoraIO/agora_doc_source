...
enum AUDIO_SOURCE_TYPE {
  /** Audio source for microphone.
   */
  AUDIO_SOURCE_MICROPHONE = 0,
  /** Audio source for loopback.
   */
  AUDIO_SOURCE_LOOPBACK = 1,
  /** Audio source for external aec.
   */
  AUDIO_SOURCE_EXTERNAL_AEC = 2,
  /** Audio source type count.
   */
...
class IRtcEngineInternal : public IRtcEngineEx,
 ...
 public:
  ...
  virtual int pushDirectCdnStreamingCustomVideoFrameEx(const webrtc::VideoFrame& frame) = 0;
