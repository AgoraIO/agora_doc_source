...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:whc="http://www.oxygenxml.com/webhelp/components" xml:lang="zh-cn" lang="zh-cn" whc:version="22.0">
    <head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0" /><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" /><meta charset="UTF-8" /><meta name="copyright" content="(C) 版权 2021" /><meta name="DC.rights.owner" content="(C) 版权 2021" /><meta name="DC.type" content="reference" /><meta name="description" content="视频设备管理方法。" /><meta name="DC.subject" content="IVideoDeviceManager, enumerateVideoDevices, startDeviceTest, stopDeviceTest, setDevice, getDevice, release" /><meta name="keywords" content="IVideoDeviceManager, enumerateVideoDevices, startDeviceTest, stopDeviceTest, setDevice, getDevice, release" /><meta name="indexterms" content="enumerateVideoDevices, startDeviceTest, stopDeviceTest, setDevice, getDevice, release" /><meta name="DC.format" content="HTML5" /><meta name="DC.identifier" content="class_ivideodevicemanager" />        
      <title>IVideoDeviceManager</title><!--  Generated with Oxygen version 23.0, build number 2020121702.  --><meta name="wh-path2root" content="../" /><meta name="wh-toc-id" content="class_ivideodevicemanager-d4991e17692" /><meta name="wh-source-relpath" content="API/class_ivideodevicemanager.dita" /><meta name="wh-out-relpath" content="API/class_ivideodevicemanager.aspx" />
...
<link rel="stylesheet" type="text/css" href="../oxygen-webhelp/template/cobalt.css?buildId=2020121702" /></head>
 ...
 See: http://oxygenxml.com/doc/versions/17.1/ug-editor/#topics/dita_webhelp_output.html.
  ...
  <div data-tooltip-position="bottom" class=" wh_breadcrumb "><ol xmlns:html="http://www.w3.org/1999/xhtml" class="d-print-none"><li><span class="home"><a href="../index.aspx"><span>主页</span></a></span></li><li><span class="topicref"><span class="title"><a href="../API/rtc_api_overview.aspx">C++ API Reference for All Platforms</a></span></span></li><li class="active"><span class="topicref" data-id="class_ivideodevicemanager"><span class="title"><a href="../API/class_ivideodevicemanager.aspx#class_ivideodevicemanager"><a xmlns:toc="http://www.oxygenxml.com/ns/webhelp/toc" xmlns:xhtml="http://www.w3.org/1999/xhtml" href="../API/class_ivideodevicemanager.html#class_ivideodevicemanager"><span class="ph">IVideoDeviceManager</span></a></a><span class="wh-tooltip"><p xmlns:toc="http://www.oxygenxml.com/ns/webhelp/toc" xmlns:xhtml="http://www.w3.org/1999/xhtml" class="shortdesc"><span class="ph">视频设备管理方法。</span></p></span></span></span></li></ol></div>
...
<article class="- topic/topic reference/reference topic reference nested1" aria-labelledby="ariaid-title2" id="api_enumeratevideodevices">
...
</article><article class="- topic/topic reference/reference topic reference nested1" aria-labelledby="ariaid-title4" id="api_stopdevicetest">
    <h2 class="- topic/title title topictitle2" id="ariaid-title4"><a href="class_ivideodevicemanager.aspx#api_stopdevicetest"><span class="- topic/ph ph">stopDeviceTest</span></a></h2>
    
    
    <div class="- topic/body reference/refbody body refbody"><p class="- topic/shortdesc shortdesc"><span class="- topic/ph ph" id="api_stopdevicetest__shortdesc">停止视频设备测试。</span></p><section class="- topic/section section" id="api_stopdevicetest__prototype"><h3 class="- topic/title title sectiontitle">原型</h3>
        
        <div class="- topic/p p">       
      <pre class="+ topic/pre pr-d/codeblock pre codeblock language-cpp"><strong class="hl-keyword">virtual</strong> <strong class="hl-keyword">int</strong> stopDeviceTest() = <span class="hl-number">0</span>;</pre>   
  </div>
        </section>
        <section class="- topic/section section" id="api_stopdevicetest__return_values"><h3 class="- topic/title title sectiontitle">返回值</h3>
...
</article><article class="- topic/topic reference/reference topic reference nested1" aria-labelledby="ariaid-title5" id="api_ivideodevicemanager_setdevice">
    <h2 class="- topic/title title topictitle2" id="ariaid-title5"><a href="class_ivideodevicemanager.aspx#api_ivideodevicemanager_setdevice"><span class="- topic/ph ph">setDevice</span></a></h2>
    
    
    <div class="- topic/body reference/refbody body refbody"><p class="- topic/shortdesc shortdesc"><span class="- topic/ph ph" id="api_ivideodevicemanager_setdevice__shortdesc">指定设备。</span></p><section class="- topic/section section" id="api_ivideodevicemanager_setdevice__prototype"><h3 class="- topic/title title sectiontitle">原型</h3>
      ...
      <pre class="+ topic/pre pr-d/codeblock pre codeblock language-cpp"><strong class="hl-keyword">virtual</strong> <strong class="hl-keyword">int</strong> setDevice(<strong class="hl-keyword">const</strong> <strong class="hl-keyword">char</strong> deviceId[MAX_DEVICE_ID_LENGTH]) = <span class="hl-number">0</span>;</pre>   
        ...
        <section class="- topic/section section" id="api_ivideodevicemanager_setdevice__detailed_desc"><h3 class="- topic/title title sectiontitle">详细描述</h3>
   
   <div class="- topic/note note note note_note"><span class="note__title">注：</span> 插拔设备不会改变设备 ID。</div>
        </section>
        <section class="- topic/section section" id="api_ivideodevicemanager_setdevice__parameters"><h3 class="- topic/title title sectiontitle">参数</h3>
   <dl class="+ topic/dl pr-d/parml dl parml">
       
  <dt class="+ topic/dt pr-d/pt dt pt dlterm">deviceId</dt>
  <dd class="+ topic/dd pr-d/pd dd pd">设备 ID。可通过调用 <a class="- topic/xref xref" href="class_ivideodevicemanager.aspx#api_enumeratevideodevices" title="获取系统中所有的视频设备列表。"><span class="- topic/keyword keyword">enumerateVideoDevices</span></a> 方法获取。最大长度为 <a class="- topic/xref xref" href="rtc_api_data_type.aspx#enum_maxdeviceidlengthtype__MAX_DEVICE_ID_LENGTH">MAX_DEVICE_ID_LENGTH</a>。</dd>
       
   </dl>
        </section>
        <section class="- topic/section section" id="api_ivideodevicemanager_setdevice__return_values"><h3 class="- topic/title title sectiontitle">返回值</h3>
...
</article><article class="- topic/topic reference/reference topic reference nested1" aria-labelledby="ariaid-title6" id="api_ivideodevicemanager_getdevice">
    <h2 class="- topic/title title topictitle2" id="ariaid-title6"><a href="class_ivideodevicemanager.aspx#api_ivideodevicemanager_getdevice"><span class="- topic/ph ph">getDevice</span></a></h2>
    
    
    <div class="- topic/body reference/refbody body refbody"><p class="- topic/shortdesc shortdesc"><span class="- topic/ph ph" id="api_ivideodevicemanager_getdevice__shortdesc">获取指定 index 的视频采集设备信息。</span></p><section class="- topic/section section" id="api_ivideodevicemanager_getdevice__prototype"><h3 class="- topic/title title sectiontitle">原型</h3>
        
        <div class="- topic/p p">       
      <pre class="+ topic/pre pr-d/codeblock pre codeblock language-cpp"><strong class="hl-keyword">virtual</strong> <strong class="hl-keyword">int</strong> getDevice(<strong class="hl-keyword">char</strong> deviceId[MAX_DEVICE_ID_LENGTH]) = <span class="hl-number">0</span>;</pre>  
  </div>
        </section>
        <section class="- topic/section section" id="api_ivideodevicemanager_getdevice__parameters"><h3 class="- topic/title title sectiontitle">参数</h3>
   <dl class="+ topic/dl pr-d/parml dl parml">
  ...
  <dd class="+ topic/dd pr-d/pd dd pd">输出参数。设备 ID。最大长度为 <a class="- topic/xref xref" href="rtc_api_data_type.aspx#enum_maxdeviceidlengthtype__MAX_DEVICE_ID_LENGTH">MAX_DEVICE_ID_LENGTH</a>。</dd>
        ...
        <section class="- topic/section section" id="api_ivideodevicemanager_getdevice__return_values"><h3 class="- topic/title title sectiontitle">返回值</h3>
...
</article><article class="- topic/topic reference/reference topic reference nested1" aria-labelledby="ariaid-title7" id="api_ivideodevicemanager_release">
    <h2 class="- topic/title title topictitle2" id="ariaid-title7"><a href="class_ivideodevicemanager.aspx#api_ivideodevicemanager_release"><span class="- topic/ph ph">release</span></a></h2>
    
    
    <div class="- topic/body reference/refbody body refbody"><p class="- topic/shortdesc shortdesc"><span class="- topic/ph ph" id="api_ivideodevicemanager_release__shortdesc">释放 <a class="- topic/xref xref" href="class_ivideodevicemanager.aspx#class_ivideodevicemanager" title="视频设备管理方法。"><span class="- topic/keyword keyword">IVideoDeviceManager</span></a> 对象占用的所有资源。</span></p><section class="- topic/section section" id="api_ivideodevicemanager_release__prototype"><h3 class="- topic/title title sectiontitle">原型</h3>
 ...
 <div class=" wh_topic_toc "><div class="wh_topic_label">在本页上</div><ul><li class="section-item"><div class="section-title"><a href="#class_ivideodevicemanager__detailed_desc" data-tocid="class_ivideodevicemanager__detailed_desc">详细描述</a></div></li><li class="topic-item"><a href="#api_enumeratevideodevices" data-tocid="api_enumeratevideodevices"><a href="class_ivideodevicemanager.aspx#api_enumeratevideodevices"><span class="- topic/ph ph">enumerateVideoDevices</span></a></a><ul><li class="section-item"><div class="section-title"><a href="#api_enumeratevideodevices__prototype" data-tocid="api_enumeratevideodevices__prototype">原型</a></div></li><li class="section-item"><div class="section-title"><a href="#api_enumeratevideodevices__detailed_desc" data-tocid="api_enumeratevideodevices__detailed_desc">详细描述</a></div></li><li class="section-item"><div class="section-title"><a href="#api_enumeratevideodevices__return_values" data-tocid="api_enumeratevideodevices__return_values">返回值</a></div></li></ul></li><li class="topic-item"><a href="#api_startdevicetest" data-tocid="api_startdevicetest"><a href="class_ivideodevicemanager.aspx#api_startdevicetest"><span class="- topic/ph ph">startDeviceTest</span></a></a><ul><li class="section-item"><div class="section-title"><a href="#api_startdevicetest__prototype" data-tocid="api_startdevicetest__prototype">原型</a></div></li><li class="section-item"><div class="section-title"><a href="#api_startdevicetest__detailed_desc" data-tocid="api_startdevicetest__detailed_desc">详细描述</a></div></li><li class="section-item"><div class="section-title"><a href="#api_startdevicetest__parameters" data-tocid="api_startdevicetest__parameters">参数</a></div></li><li class="section-item"><div class="section-title"><a href="#api_startdevicetest__return_values" data-tocid="api_startdevicetest__return_values">返回值</a></div></li></ul></li><li class="topic-item"><a href="#api_stopdevicetest" data-tocid="api_stopdevicetest"><a href="class_ivideodevicemanager.aspx#api_stopdevicetest"><span class="- topic/ph ph">stopDeviceTest</span></a></a><ul><li class="section-item"><div class="section-title"><a href="#api_stopdevicetest__prototype" data-tocid="api_stopdevicetest__prototype">原型</a></div></li><li class="section-item"><div class="section-title"><a href="#api_stopdevicetest__return_values" data-tocid="api_stopdevicetest__return_values">返回值</a></div></li></ul></li><li class="topic-item"><a href="#api_ivideodevicemanager_setdevice" data-tocid="api_ivideodevicemanager_setdevice"><a href="class_ivideodevicemanager.aspx#api_ivideodevicemanager_setdevice"><span class="- topic/ph ph">setDevice</span></a></a><ul><li class="section-item"><div class="section-title"><a href="#api_ivideodevicemanager_setdevice__prototype" data-tocid="api_ivideodevicemanager_setdevice__prototype">原型</a></div></li><li class="section-item"><div class="section-title"><a href="#api_ivideodevicemanager_setdevice__detailed_desc" data-tocid="api_ivideodevicemanager_setdevice__detailed_desc">详细描述</a></div></li><li class="section-item"><div class="section-title"><a href="#api_ivideodevicemanager_setdevice__parameters" data-tocid="api_ivideodevicemanager_setdevice__parameters">参数</a></div></li><li class="section-item"><div class="section-title"><a href="#api_ivideodevicemanager_setdevice__return_values" data-tocid="api_ivideodevicemanager_setdevice__return_values">返回值</a></div></li></ul></li><li class="topic-item"><a href="#api_ivideodevicemanager_getdevice" data-tocid="api_ivideodevicemanager_getdevice"><a href="class_ivideodevicemanager.aspx#api_ivideodevicemanager_getdevice"><span class="- topic/ph ph">getDevice</span></a></a><ul><li class="section-item"><div class="section-title"><a href="#api_ivideodevicemanager_getdevice__prototype" data-tocid="api_ivideodevicemanager_getdevice__prototype">原型</a></div></li><li class="section-item"><div class="section-title"><a href="#api_ivideodevicemanager_getdevice__parameters" data-tocid="api_ivideodevicemanager_getdevice__parameters">参数</a></div></li><li class="section-item"><div class="section-title"><a href="#api_ivideodevicemanager_getdevice__return_values" data-tocid="api_ivideodevicemanager_getdevice__return_values">返回值</a></div></li></ul></li><li class="topic-item"><a href="#api_ivideodevicemanager_release" data-tocid="api_ivideodevicemanager_release"><a href="class_ivideodevicemanager.aspx#api_ivideodevicemanager_release"><span class="- topic/ph ph">release</span></a></a><ul><li class="section-item"><div class="section-title"><a href="#api_ivideodevicemanager_release__prototype" data-tocid="api_ivideodevicemanager_release__prototype">原型</a></div></li></ul></li></ul></div>
      </nav>
