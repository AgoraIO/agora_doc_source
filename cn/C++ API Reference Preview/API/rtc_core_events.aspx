...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:whc="http://www.oxygenxml.com/webhelp/components" xml:lang="zh-cn" lang="zh-cn" whc:version="22.0">
    <head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0" /><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" /><meta name="description" content="" /><meta charset="UTF-8" /><meta name="copyright" content="(C) 版权 2021" /><meta name="DC.rights.owner" content="(C) 版权 2021" /><meta name="DC.type" content="topic" /><meta name="DC.relation" scheme="URI" content="../API/rtc_core_methods.aspx" /><meta name="DC.format" content="HTML5" /><meta name="DC.identifier" content="channel_management_callbacks" /><title>频道事件</title><!--  Generated with Oxygen version 23.0, build number 2020121702.  --><meta name="wh-path2root" content="../" /><meta name="wh-source-relpath" content="API/rtc_core_events.dita" /><meta name="wh-out-relpath" content="API/rtc_core_events.aspx" />
...
<link rel="stylesheet" type="text/css" href="../oxygen-webhelp/template/cobalt.css?buildId=2020121702" /></head>
    ...
    <body id="channel_management_callbacks" class="wh_topic_page frmBody">
 ...
 See: http://oxygenxml.com/doc/versions/17.1/ug-editor/#topics/dita_webhelp_output.html.
  ...
  <div class="col-12" id="wh_topic_body">
    ...
    <h1 class="- topic/title title topictitle1" id="ariaid-title1">频道事件</h1>
    <div class="- topic/body body">
        <p class="- topic/p p"></p>
    </div>
</article></main></div>
      
      <div class=" wh_related_links d-print-none "><nav aria-label="Related Links" role="navigation" class="- topic/related-links related-links"><div class="- topic/linklist linklist relref"><strong>相关参考</strong><ul class="linklist related_link"><li class="linklist"><a class="navheader_parent_path" href="../API/rtc_core_methods.aspx" title="频道管理">频道管理</a></li></ul></div></nav></div>
