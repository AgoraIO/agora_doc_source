...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:whc="http://www.oxygenxml.com/webhelp/components" xml:lang="zh-cn" lang="zh-cn" whc:version="22.0">
    <head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0" /><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" /><meta charset="UTF-8" /><meta name="copyright" content="(C) 版权 2021" /><meta name="DC.rights.owner" content="(C) 版权 2021" /><meta name="DC.type" content="reference" /><meta name="description" content="IVideoFrameConsumer 类，用于让 SDK 接收你采集的视频帧。" /><meta name="DC.subject" content="IVideoFrameConsumer, consumeRawVideoFrame" /><meta name="keywords" content="IVideoFrameConsumer, consumeRawVideoFrame" /><meta name="indexterms" content="consumeRawVideoFrame" /><meta name="DC.format" content="HTML5" /><meta name="DC.identifier" content="class_ivideoframeconsumer" />        
      <title>IVideoFrameConsumer</title><!--  Generated with Oxygen version 23.0, build number 2020121702.  --><meta name="wh-path2root" content="../" /><meta name="wh-toc-id" content="class_ivideoframeconsumer-d4991e17664" /><meta name="wh-source-relpath" content="API/class_ivideoframeconsumer.dita" /><meta name="wh-out-relpath" content="API/class_ivideoframeconsumer.aspx" />
...
<link rel="stylesheet" type="text/css" href="../oxygen-webhelp/template/cobalt.css?buildId=2020121702" /></head>
 ...
 See: http://oxygenxml.com/doc/versions/17.1/ug-editor/#topics/dita_webhelp_output.html.
  ...
  <div data-tooltip-position="bottom" class=" wh_breadcrumb "><ol xmlns:html="http://www.w3.org/1999/xhtml" class="d-print-none"><li><span class="home"><a href="../index.aspx"><span>主页</span></a></span></li><li><span class="topicref"><span class="title"><a href="../API/rtc_api_overview.aspx">C++ API Reference for All Platforms</a></span></span></li><li class="active"><span class="topicref" data-id="class_ivideoframeconsumer"><span class="title"><a href="../API/class_ivideoframeconsumer.aspx#class_ivideoframeconsumer"><a xmlns:toc="http://www.oxygenxml.com/ns/webhelp/toc" xmlns:xhtml="http://www.w3.org/1999/xhtml" href="../API/class_ivideoframeconsumer.html#class_ivideoframeconsumer"><span class="ph">IVideoFrameConsumer</span></a></a><span class="wh-tooltip"><p xmlns:toc="http://www.oxygenxml.com/ns/webhelp/toc" xmlns:xhtml="http://www.w3.org/1999/xhtml" class="shortdesc"><span class="ph"><span class="keyword apiname">IVideoFrameConsumer</span> 类，用于让 SDK 接收你采集的视频帧。</span></p></span></span></span></li></ol></div>
...
<article class="- topic/topic reference/reference topic reference nested1" aria-labelledby="ariaid-title2" id="api_consumerawvideoframe">
  ...
  <dt class="+ topic/dt pr-d/pt dt pt dlterm">frameType</dt>
  <dd class="+ topic/dd pr-d/pd dd pd">视频帧类型。详见 <a class="- topic/xref xref" href="rtc_api_data_type.aspx#enum_videopixelformat" title="视频像素格式。"><span class="- topic/keyword keyword">VIDEO_PIXEL_FORMAT</span></a>。</dd>
       
       
  <dt class="+ topic/dt pr-d/pt dt pt dlterm">width</dt>
  <dd class="+ topic/dd pr-d/pd dd pd">视频帧的宽度（px）。</dd>
       
       
  <dt class="+ topic/dt pr-d/pt dt pt dlterm">height</dt>
  <dd class="+ topic/dd pr-d/pd dd pd">视频帧的高度（px）。</dd>
       
       
  <dt class="+ topic/dt pr-d/pt dt pt dlterm">rotation</dt>
  <dd class="+ topic/dd pr-d/pd dd pd">视频帧顺时针旋转的角度。如果设置了旋转角度，视频帧发送给 SDK 后，SDK 会对视频图像进行旋转。 取值可为 0 度、90 度、180 度和 270
      度。</dd>
       
       
  <dt class="+ topic/dt pr-d/pt dt pt dlterm">timestamp</dt>
  <dd class="+ topic/dd pr-d/pd dd pd">视频帧的 Unix 时间戳（毫秒）。你必须为每一帧视频帧设置一个时间戳。</dd>
 ...
 <div class=" wh_topic_toc "><div class="wh_topic_label">在本页上</div><ul><li class="topic-item"><a href="#api_consumerawvideoframe" data-tocid="api_consumerawvideoframe"><a href="class_ivideoframeconsumer.aspx#api_consumerawvideoframe"><span class="- topic/ph ph">consumeRawVideoFrame</span></a></a><ul><li class="section-item"><div class="section-title"><a href="#api_consumerawvideoframe__prototype" data-tocid="api_consumerawvideoframe__prototype">原型</a></div></li><li class="section-item"><div class="section-title"><a href="#api_consumerawvideoframe__detailed_desc" data-tocid="api_consumerawvideoframe__detailed_desc">详细描述</a></div></li><li class="section-item"><div class="section-title"><a href="#api_consumerawvideoframe__parameters" data-tocid="api_consumerawvideoframe__parameters">参数</a></div></li></ul></li></ul></div>
      </nav>
