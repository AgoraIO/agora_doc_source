...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:whc="http://www.oxygenxml.com/webhelp/components" xml:lang="zh-cn" lang="zh-cn" whc:version="22.0">
    <head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0" /><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" /><meta charset="UTF-8" /><meta name="copyright" content="(C) 版权 2021" /><meta name="DC.rights.owner" content="(C) 版权 2021" /><meta name="DC.type" content="reference" /><meta name="description" content="检测设备是否支持手动对焦功能。" /><meta name="DC.subject" content="isCameraFocusSupported" /><meta name="keywords" content="isCameraFocusSupported" /><meta name="indexterms" content="isCameraFocusSupported" /><meta name="DC.format" content="HTML5" /><meta name="DC.identifier" content="api_iscamerafocussupported" />        
      <title>isCameraFocusSupported</title><!--  Generated with Oxygen version 23.0, build number 2020121702.  --><meta name="wh-path2root" content="../" /><meta name="wh-source-relpath" content="API/api_iscamerafocussupported.dita" /><meta name="wh-out-relpath" content="API/api_iscamerafocussupported.aspx" />
...
<link rel="stylesheet" type="text/css" href="../oxygen-webhelp/template/cobalt.css?buildId=2020121702" /></head>
    ...
    <body id="api_iscamerafocussupported" class="wh_topic_page frmBody">
 ...
 See: http://oxygenxml.com/doc/versions/17.1/ug-editor/#topics/dita_webhelp_output.html.
  ...
  <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12" id="wh_topic_body">
    ...
    <h1 class="- topic/title title topictitle1" id="ariaid-title1"><a href="api_iscamerafocussupported.aspx"><span class="- topic/ph ph">isCameraFocusSupported</span></a></h1>
    
    
    <div class="- topic/body reference/refbody body refbody"><p class="- topic/shortdesc shortdesc"><span class="- topic/ph ph" id="api_iscamerafocussupported__shortdesc">检测设备是否支持手动对焦功能。</span></p><section class="- topic/section section" id="api_iscamerafocussupported__prototype"><h2 class="- topic/title title sectiontitle">原型</h2>
        
        <p class="- topic/p p">
      
  </p>
        </section>
        <section class="- topic/section section" id="api_iscamerafocussupported__detailed_desc"><h2 class="- topic/title title sectiontitle">详细描述</h2>
   ...
   <p class="- topic/p p">该方法需要在相机启动（如通过调用 <a class="- topic/xref xref" href="class_irtcengine.aspx#api_startpreview" title="开启视频预览。"><span class="- topic/keyword keyword">startPreview</span></a> 或 <a class="- topic/xref xref" href="class_irtcengine.aspx#api_joinchannel" title="加入频道。"><span class="- topic/keyword keyword">joinChannel</span></a> 实现）后调用。</p>
        ...
        <section class="- topic/section section" id="api_iscamerafocussupported__return_values"><h2 class="- topic/title title sectiontitle">返回值</h2>
   
   <ul class="- topic/ul ul">
       <li class="- topic/li li"><span class="- topic/ph ph">true</span>: 设备支持手动对焦功能。</li>
       <li class="- topic/li li"><span class="- topic/ph ph">false</span>: 设备不支持手动对焦功能。</li>
   </ul>
        </section></div>
</article></main></div>
 ...
 <div class=" wh_topic_toc "><div class="wh_topic_label">在本页上</div><ul><li class="section-item"><div class="section-title"><a href="#api_iscamerafocussupported__prototype" data-tocid="api_iscamerafocussupported__prototype">原型</a></div></li><li class="section-item"><div class="section-title"><a href="#api_iscamerafocussupported__detailed_desc" data-tocid="api_iscamerafocussupported__detailed_desc">详细描述</a></div></li><li class="section-item"><div class="section-title"><a href="#api_iscamerafocussupported__return_values" data-tocid="api_iscamerafocussupported__return_values">返回值</a></div></li></ul></div>
      </nav>
