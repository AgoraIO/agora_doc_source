...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:whc="http://www.oxygenxml.com/webhelp/components" xml:lang="zh-cn" lang="zh-cn" whc:version="22.0">
    <head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0" /><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" /><meta charset="UTF-8" /><meta name="copyright" content="(C) 版权 2021" /><meta name="DC.rights.owner" content="(C) 版权 2021" /><meta name="DC.type" content="reference" /><meta name="description" content="获取 Native SDK 的 C++ 句柄。" /><meta name="DC.subject" content="getNativeHandle" /><meta name="keywords" content="getNativeHandle" /><meta name="indexterms" content="getNativeHandle" /><meta name="DC.format" content="HTML5" /><meta name="DC.identifier" content="api_getnativehandle" />        
      <title>getNativeHandle</title><!--  Generated with Oxygen version 23.0, build number 2020121702.  --><meta name="wh-path2root" content="../" /><meta name="wh-source-relpath" content="API/api_getnativehandle.dita" /><meta name="wh-out-relpath" content="API/api_getnativehandle.aspx" />
...
<link rel="stylesheet" type="text/css" href="../oxygen-webhelp/template/cobalt.css?buildId=2020121702" /></head>
    ...
    <body id="api_getnativehandle" class="wh_topic_page frmBody">
 ...
 See: http://oxygenxml.com/doc/versions/17.1/ug-editor/#topics/dita_webhelp_output.html.
  ...
  <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12" id="wh_topic_body">
    ...
    <h1 class="- topic/title title topictitle1" id="ariaid-title1"><a href="api_getnativehandle.aspx"><span class="- topic/ph ph">getNativeHandle</span></a></h1>
    
    
    <div class="- topic/body reference/refbody body refbody"><p class="- topic/shortdesc shortdesc"><span class="- topic/ph ph" id="api_getnativehandle__shortdesc">获取 Native SDK 的 C++ 句柄。</span></p><section class="- topic/section section" id="api_getnativehandle__prototype"><h2 class="- topic/title title sectiontitle">原型</h2>
        ...
        <section class="- topic/section section" id="api_getnativehandle__detailed_desc"><h2 class="- topic/title title sectiontitle">详细描述</h2>
   
   <p class="- topic/p p">该方法获取 Native SDK engine 的 C++ 句柄，用于包括注册音视频帧观测器在内的特殊场景。</p>
        </section>
</div>
</article></main></div>
 ...
 <div class=" wh_topic_toc "><div class="wh_topic_label">在本页上</div><ul><li class="section-item"><div class="section-title"><a href="#api_getnativehandle__prototype" data-tocid="api_getnativehandle__prototype">原型</a></div></li><li class="section-item"><div class="section-title"><a href="#api_getnativehandle__detailed_desc" data-tocid="api_getnativehandle__detailed_desc">详细描述</a></div></li></ul></div>
      </nav>
