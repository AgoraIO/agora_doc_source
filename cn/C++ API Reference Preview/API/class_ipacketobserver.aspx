...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:whc="http://www.oxygenxml.com/webhelp/components" xml:lang="zh-cn" lang="zh-cn" whc:version="22.0">
    <head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0" /><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" /><meta charset="UTF-8" /><meta name="copyright" content="(C) 版权 2021" /><meta name="DC.rights.owner" content="(C) 版权 2021" /><meta name="DC.type" content="reference" /><meta name="description" content="IPacketObserver 定义。" /><meta name="DC.subject" content="IPacketObserver, onReceiveAudioPacket, onReceiveVideoPacket, onSendAudioPacket, onSendVideoPacket" /><meta name="keywords" content="IPacketObserver, onReceiveAudioPacket, onReceiveVideoPacket, onSendAudioPacket, onSendVideoPacket" /><meta name="indexterms" content="onReceiveAudioPacket, onReceiveVideoPacket, onSendAudioPacket, onSendVideoPacket" /><meta name="DC.format" content="HTML5" /><meta name="DC.identifier" content="class_ipacketobserver" />        
      <title>IPacketObserver</title><!--  Generated with Oxygen version 23.0, build number 2020121702.  --><meta name="wh-path2root" content="../" /><meta name="wh-toc-id" content="class_ipacketobserver-d4991e17061" /><meta name="wh-source-relpath" content="API/class_ipacketobserver.dita" /><meta name="wh-out-relpath" content="API/class_ipacketobserver.aspx" />
...
<link rel="stylesheet" type="text/css" href="../oxygen-webhelp/template/cobalt.css?buildId=2020121702" /></head>
 ...
 See: http://oxygenxml.com/doc/versions/17.1/ug-editor/#topics/dita_webhelp_output.html.
  ...
  <div data-tooltip-position="bottom" class=" wh_breadcrumb "><ol xmlns:html="http://www.w3.org/1999/xhtml" class="d-print-none"><li><span class="home"><a href="../index.aspx"><span>主页</span></a></span></li><li><span class="topicref"><span class="title"><a href="../API/rtc_api_overview.aspx">C++ API Reference for All Platforms</a></span></span></li><li class="active"><span class="topicref" data-id="class_ipacketobserver"><span class="title"><a href="../API/class_ipacketobserver.aspx#class_ipacketobserver"><a xmlns:toc="http://www.oxygenxml.com/ns/webhelp/toc" xmlns:xhtml="http://www.w3.org/1999/xhtml" href="../API/class_ipacketobserver.html#class_ipacketobserver"><span class="ph">IPacketObserver</span></a></a><span class="wh-tooltip"><p xmlns:toc="http://www.oxygenxml.com/ns/webhelp/toc" xmlns:xhtml="http://www.w3.org/1999/xhtml" class="shortdesc"><span class="ph">IPacketObserver 定义。</span></p></span></span></span></li></ol></div>
...
<article class="- topic/topic reference/reference topic reference nested1" aria-labelledby="ariaid-title2" id="api_onreceiveaudiopacket">
  ...
  <dd class="+ topic/dd pr-d/pd dd pd">详见: <a class="- topic/xref xref" href="rtc_api_data_type.aspx#class_packet" title="Packet 定义。"><span class="- topic/keyword keyword">Packet</span></a> 。</dd>
        ...
        <section class="- topic/section section" id="api_onreceivevideopacket__return_values"><h3 class="- topic/title title sectiontitle">返回值</h3>
...
</article><article class="- topic/topic reference/reference topic reference nested1" aria-labelledby="ariaid-title4" id="api_onsendaudiopacket">
    <h2 class="- topic/title title topictitle2" id="ariaid-title4"><a href="class_ipacketobserver.aspx#api_onsendaudiopacket"><span class="- topic/ph ph">onSendAudioPacket</span></a></h2>
    
    
    <div class="- topic/body reference/refbody body refbody"><p class="- topic/shortdesc shortdesc"><span class="- topic/ph ph" id="api_onsendaudiopacket__shortdesc">已发送音频包回调。</span></p><section class="- topic/section section" id="api_onsendaudiopacket__prototype"><h3 class="- topic/title title sectiontitle">原型</h3>
        
        <div class="- topic/p p">       
      <pre class="+ topic/pre pr-d/codeblock pre codeblock language-cpp"><strong class="hl-keyword">virtual</strong> <strong class="hl-keyword">bool</strong> onSendAudioPacket(Packet&amp; packet) = <span class="hl-number">0</span>;</pre>   
  </div>
        </section>
        <section class="- topic/section section" id="api_onsendaudiopacket__detailed_desc"><h3 class="- topic/title title sectiontitle">详细描述</h3>
   
   <p class="- topic/p p">在音频包被发送给对方用户前由 SDK 调用。</p>
        </section>
        <section class="- topic/section section" id="api_onsendaudiopacket__parameters"><h3 class="- topic/title title sectiontitle">参数</h3>
   <dl class="+ topic/dl pr-d/parml dl parml">
  ...
  <dd class="+ topic/dd pr-d/pd dd pd">详见: <a class="- topic/xref xref" href="rtc_api_data_type.aspx#class_packet" title="Packet 定义。"><span class="- topic/keyword keyword">Packet</span></a> 。</dd>
        ...
        <section class="- topic/section section" id="api_onsendaudiopacket__return_values"><h3 class="- topic/title title sectiontitle">返回值</h3>
...
</article><article class="- topic/topic reference/reference topic reference nested1" aria-labelledby="ariaid-title5" id="api_onsendvideopacket">
    <h2 class="- topic/title title topictitle2" id="ariaid-title5"><a href="class_ipacketobserver.aspx#api_onsendvideopacket"><span class="- topic/ph ph">onSendVideoPacket</span></a></h2>
    
    
    <div class="- topic/body reference/refbody body refbody"><p class="- topic/shortdesc shortdesc"><span class="- topic/ph ph" id="api_onsendvideopacket__shortdesc">已发送视频包回调。</span></p><section class="- topic/section section" id="api_onsendvideopacket__prototype"><h3 class="- topic/title title sectiontitle">原型</h3>
        
        <div class="- topic/p p">       
      <pre class="+ topic/pre pr-d/codeblock pre codeblock language-cpp"><strong class="hl-keyword">virtual</strong> <strong class="hl-keyword">bool</strong> onSendVideoPacket(Packet&amp; packet) = <span class="hl-number">0</span>;</pre>   
  </div>
        </section>
        <section class="- topic/section section" id="api_onsendvideopacket__detailed_desc"><h3 class="- topic/title title sectiontitle">详细描述</h3>
   
   <p class="- topic/p p">在视频包被发送给对方用户前由 SDK 调用。</p>
        </section>
        <section class="- topic/section section" id="api_onsendvideopacket__parameters"><h3 class="- topic/title title sectiontitle">参数</h3>
   <dl class="+ topic/dl pr-d/parml dl parml">
  ...
  <dd class="+ topic/dd pr-d/pd dd pd">详见: <a class="- topic/xref xref" href="rtc_api_data_type.aspx#class_packet" title="Packet 定义。"><span class="- topic/keyword keyword">Packet</span></a> 。</dd>
        ...
        <section class="- topic/section section" id="api_onsendvideopacket__return_values"><h3 class="- topic/title title sectiontitle">返回值</h3>
 ...
 <div class=" wh_topic_toc "><div class="wh_topic_label">在本页上</div><ul><li class="topic-item"><a href="#api_onreceiveaudiopacket" data-tocid="api_onreceiveaudiopacket"><a href="class_ipacketobserver.aspx#api_onreceiveaudiopacket"><span class="- topic/ph ph">onReceiveAudioPacket</span></a></a><ul><li class="section-item"><div class="section-title"><a href="#api_onreceiveaudiopacket__prototype" data-tocid="api_onreceiveaudiopacket__prototype">原型</a></div></li><li class="section-item"><div class="section-title"><a href="#api_onreceiveaudiopacket__detailed_desc" data-tocid="api_onreceiveaudiopacket__detailed_desc">详细描述</a></div></li><li class="section-item"><div class="section-title"><a href="#api_onreceiveaudiopacket__parameters" data-tocid="api_onreceiveaudiopacket__parameters">参数</a></div></li><li class="section-item"><div class="section-title"><a href="#api_onreceiveaudiopacket__return_values" data-tocid="api_onreceiveaudiopacket__return_values">返回值</a></div></li></ul></li><li class="topic-item"><a href="#api_onreceivevideopacket" data-tocid="api_onreceivevideopacket"><a href="class_ipacketobserver.aspx#api_onreceivevideopacket"><span class="- topic/ph ph">onReceiveVideoPacket</span></a></a><ul><li class="section-item"><div class="section-title"><a href="#api_onreceivevideopacket__prototype" data-tocid="api_onreceivevideopacket__prototype">原型</a></div></li><li class="section-item"><div class="section-title"><a href="#api_onreceivevideopacket__detailed_desc" data-tocid="api_onreceivevideopacket__detailed_desc">详细描述</a></div></li><li class="section-item"><div class="section-title"><a href="#api_onreceivevideopacket__parameters" data-tocid="api_onreceivevideopacket__parameters">参数</a></div></li><li class="section-item"><div class="section-title"><a href="#api_onreceivevideopacket__return_values" data-tocid="api_onreceivevideopacket__return_values">返回值</a></div></li></ul></li><li class="topic-item"><a href="#api_onsendaudiopacket" data-tocid="api_onsendaudiopacket"><a href="class_ipacketobserver.aspx#api_onsendaudiopacket"><span class="- topic/ph ph">onSendAudioPacket</span></a></a><ul><li class="section-item"><div class="section-title"><a href="#api_onsendaudiopacket__prototype" data-tocid="api_onsendaudiopacket__prototype">原型</a></div></li><li class="section-item"><div class="section-title"><a href="#api_onsendaudiopacket__detailed_desc" data-tocid="api_onsendaudiopacket__detailed_desc">详细描述</a></div></li><li class="section-item"><div class="section-title"><a href="#api_onsendaudiopacket__parameters" data-tocid="api_onsendaudiopacket__parameters">参数</a></div></li><li class="section-item"><div class="section-title"><a href="#api_onsendaudiopacket__return_values" data-tocid="api_onsendaudiopacket__return_values">返回值</a></div></li></ul></li><li class="topic-item"><a href="#api_onsendvideopacket" data-tocid="api_onsendvideopacket"><a href="class_ipacketobserver.aspx#api_onsendvideopacket"><span class="- topic/ph ph">onSendVideoPacket</span></a></a><ul><li class="section-item"><div class="section-title"><a href="#api_onsendvideopacket__prototype" data-tocid="api_onsendvideopacket__prototype">原型</a></div></li><li class="section-item"><div class="section-title"><a href="#api_onsendvideopacket__detailed_desc" data-tocid="api_onsendvideopacket__detailed_desc">详细描述</a></div></li><li class="section-item"><div class="section-title"><a href="#api_onsendvideopacket__parameters" data-tocid="api_onsendvideopacket__parameters">参数</a></div></li><li class="section-item"><div class="section-title"><a href="#api_onsendvideopacket__return_values" data-tocid="api_onsendvideopacket__return_values">返回值</a></div></li></ul></li></ul></div>
      </nav>
