...
无论是何种情况，你都可以参考本文，了解这些错误码和警告码的详细含义，及其解决方法。对于未给出解决方法的错误码，建议你[提交工单](https://agora-ticket.agora.io/)，我们的技术服务会根据你在实际场景中遇到的问题进行排查。
...
| `151`    | 旁路推流报错。请调用 [removePublishStreamUrl] 删除当前的推流地址，然后调用 [addPublishStreamUrl] 重新尝试推流。 |
